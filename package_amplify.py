...
def package_amplify():
    ...
    print("Creating deploy-manifest.json...")
    manifest = {
        "version": 1,
        "framework": "nextjs",
        "routes": [
    ...
    zip_path = "amplify-deploy.zip"
    with zipfile.ZipFile(zip_path, "w", zipfile.ZIP_DEFLATED) as zipf:
        # We need to zip the CONTENTS of hosting_dir
        # The .amplify-hosting folder must be at the root of the zip
