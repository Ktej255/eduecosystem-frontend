        ...
        if response.status_code == 200:
            ...
            with engine.connect() as conn:
                ...
                if image_url and image_url.startswith("https://storage.googleapis.com"):
                    ...
                    print("\n[FAILURE] MIGRATION FAILED: image_url is still using local storage.")
                else:
                    print(f"\n[UNKNOWN] UNEXPECTED VALUE: {image_url}")
        else:
            print("\n[FAILURE] UPLOAD FAILED: Check API Error above.")
