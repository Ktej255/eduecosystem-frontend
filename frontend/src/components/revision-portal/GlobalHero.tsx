...
export default function GlobalHero() {
    return (
        <section className="relative w-full min-h-[90vh] flex items-center justify-center overflow-hidden bg-card dark:bg-neutral-950">
            ...
            <div className="container relative z-10 px-4 md:px-6 flex flex-col items-center text-center">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-card/80 dark:bg-card/10 border border-grapho-gold/30 backdrop-blur-sm shadow-sm">
                    ...
                    <h1 className="text-6xl md:text-8xl font-display font-bold tracking-tight text-grapho-ink leading-[1.1]">
                        Master Your <br />
                    ...
                    >
                        <button className="btn-ink-hover group relative px-8 py-4 rounded-full bg-grapho-ink dark:bg-card text-white dark:text-grapho-ink font-semibold text-lg shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 overflow-hidden">
                            <span className="relative z-10 flex items-center gap-2">
                                Start Free 30-Day Trial <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                            </span>
                        </button>
                        <button className="px-8 py-4 rounded-full border-2 border-neutral-200 dark:border-neutral-700 text-neutral-600 dark:text-neutral-300 font-medium text-lg hover:border-grapho-gold hover:text-grapho-gold transition-all duration-300 bg-card/50 backdrop-blur-sm">
                            View All Exams
                        </button>
                    </motion.div>
                </motion.div>
