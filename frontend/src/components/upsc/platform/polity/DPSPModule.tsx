...
const BlueprintCard = ({ title, article, children, icon: Icon, colorClass = "bg-card", borderColor = "border-border", stamp }: { title: string, article?: string, children: React.ReactNode, icon?: any, colorClass?: string, borderColor?: string, stamp?: string }) => (
    <div className={`relative ${colorClass} border-2 ${borderColor} rounded-lg p-5 shadow-sm hover:shadow-md transition-shadow`}>
        ...
        <div className="flex items-start justify-between mb-3 border-b border-black/5 pb-2">
            ...
            {Icon && (
                <div className="p-2 bg-card/50 rounded-full border border-black/10">
...
const LaneHeader = ({ title, color, desc }: { title: string, color: string, desc: string }) => (
    <div className={`flex items-center gap-3 py-2 px-4 rounded-full ${color} text-white shadow-sm inline-flex mb-4`}>
        ...
        <div className="h-4 w-[1px] bg-card/30"></div>
...
export default function DPSPModule({ onComplete, isCompleted }: DPSPModuleProps) {
    return (
        <BlueprintContainer>
            ...
            <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-card p-6 rounded-xl border-2 border-border shadow-sm relative">
                        <div className="absolute top-0 right-0 bg-muted text-muted-foreground text-[10px] font-bold px-2 py-1 rounded-bl-lg border-b border-l">SOURCE CODE</div>
                        ...
                        <div className="space-y-4 text-sm">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-muted-foreground italic">(Who borrowed from Spain)</div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-muted-foreground">Resembles GoI Act, 1935 instructions to Governors.</div>
                                    <Badge variant="outline" className="mt-1 text-[10px] text-red-600 border-red-200 bg-red-50">PYQ ASKED</Badge>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-muted-foreground">"Novel Features" of the Constitution.</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Right: Nature */}
                    <div className="bg-muted p-6 rounded-xl border-2 border-dashed border-border relative">
                        <div className="absolute -top-3 -right-3 rotate-12">
                            <div className="border-2 border-red-500 text-red-500 font-black px-3 py-1 rounded text-xs uppercase bg-card">Non-Justiciable</div>
                        </div>
                        <h3 className="text-xl font-bold text-foreground mb-4 flex items-center gap-2">
                            <Scale className="text-muted-foreground" /> The Legal Nature
                        </h3>
                        <div className="space-y-4 text-sm">
                            <div className="bg-card p-3 rounded border border-border">
                                <div className="font-bold text-foreground">Article 37: The Duty</div>
                                <div className="text-muted-foreground mt-1">Shall NOT be enforceable by any court, BUT are fundamental in governance.</div>
                            </div>
            ...
            <div className="space-y-8">
                ...
                <div className="bg-red-50/50 p-6 rounded-2xl border border-red-100">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <BlueprintCard title="Welfare State" article="Art 38" colorClass="bg-card" borderColor="border-red-200">
                        ...
                        <BlueprintCard title="The Big One" article="Art 39" colorClass="bg-card" borderColor="border-red-200" stamp="HIGH YIELD">
                        ...
                        <BlueprintCard title="Right to Work" article="Art 41" colorClass="bg-card" borderColor="border-red-200" icon={Briefcase}>
                            Right to work, education & public assistance (Old age, sickness).
                        </BlueprintCard>

                        <BlueprintCard title="Humane Conditions" article="Art 42" colorClass="bg-card" borderColor="border-red-200" icon={Heart}>
                            Just conditions of work & Maternity Relief.
                        </BlueprintCard>

                        <BlueprintCard title="Workers in Mgmt" article="Art 43A" colorClass="bg-card" borderColor="border-red-200" icon={Factory}>
                ...
                <div className="bg-orange-50/50 p-6 rounded-2xl border border-orange-100">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <BlueprintCard title="Village Panchayats" article="Art 40" colorClass="bg-card" borderColor="border-orange-200" icon={Building2} stamp="PYQ">
                            Organize village panchayats & give them powers.
                        </BlueprintCard>

                        <BlueprintCard title="Cottage Industries" article="Art 43" colorClass="bg-card" borderColor="border-orange-200" icon={Users}>
                            Promote on individual or co-operative basis in rural areas.
                        </BlueprintCard>

                        <BlueprintCard title="Co-operatives" article="Art 43B" colorClass="bg-card" borderColor="border-orange-200" icon={Handshake}>
                            Promote autonomous functioning. <br />
                            <span className="text-[10px] text-orange-600 font-bold">(97th AA, 2011)</span>
                        </BlueprintCard>

                        <BlueprintCard title="Weaker Sections" article="Art 46" colorClass="bg-card" borderColor="border-orange-200" icon={UserCheck}>
                            Promote educational/economic interests of SCs, STs.
                        </BlueprintCard>

                        <BlueprintCard title="Prohibition" article="Art 47" colorClass="bg-card" borderColor="border-orange-200" icon={Ban}>
                            Prohibit intoxicating drinks & drugs injurious to health.
                        </BlueprintCard>

                        <BlueprintCard title="Cattle Slaughter" article="Art 48" colorClass="bg-card" borderColor="border-orange-200" icon={Milk}>
                ...
                <div className="bg-blue-50/50 p-6 rounded-2xl border border-blue-100">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <BlueprintCard title="Uniform Civil Code" article="Art 44" colorClass="bg-card" borderColor="border-blue-200" icon={Scale} stamp="PYQ">
                            Secure UCC for citizens. <br />
                            <span className="text-[10px] opacity-70 italic">(Only Goa has UCC)</span>
                        </BlueprintCard>

                        <BlueprintCard title="Early Child Care" article="Art 45" colorClass="bg-card" borderColor="border-blue-200" icon={GraduationCap}>
                            ECCE for children until age 6. <br />
                            <span className="text-[10px] text-blue-600 font-bold">(Subject changed by 86th AA)</span>
                        </BlueprintCard>

                        <BlueprintCard title="Modern Agri" article="Art 48" colorClass="bg-card" borderColor="border-blue-200" icon={Leaf}>
                            Organize agri & animal husbandry on scientific lines.
                        </BlueprintCard>

                        <BlueprintCard title="Environment" article="Art 48A" colorClass="bg-card" borderColor="border-blue-200" icon={Leaf} stamp="42nd AA">
                            Protect & improve environment, forests & wildlife.
                        </BlueprintCard>

                        <BlueprintCard title="Separation of Powers" article="Art 50" colorClass="bg-card" borderColor="border-blue-200" icon={Split} stamp="PYQ">
                            Separate Judiciary from Executive.
                        </BlueprintCard>

                        <BlueprintCard title="Intl Peace" article="Art 51" colorClass="bg-card" borderColor="border-blue-200" icon={Globe}>
            ...
            <div className="relative border-l-4 border-border ml-4 md:ml-8 space-y-8 pl-8 py-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                    <div className="bg-card p-4 rounded-lg shadow-sm border-l-4 border-red-500">
                        <div className="text-xs text-muted-foreground font-bold">1951 • Champakam Dorairajan</div>
                    ...
                    <div className="bg-card p-4 rounded-lg shadow-sm border-l-4 border-orange-500">
                        <div className="text-xs text-muted-foreground font-bold">1967 • Golaknath</div>
                    ...
                    <div className="bg-card p-4 rounded-lg shadow-sm border-l-4 border-yellow-500">
                        <div className="text-xs text-muted-foreground font-bold">1971 • 25th Amendment</div>
                ...
                <div className="bg-gradient-to-br from-slate-800 to-slate-900 text-white p-8 rounded-2xl flex flex-col justify-center items-center text-center shadow-2xl relative overflow-hidden">
                    ...
                    <div className="bg-card/10 p-4 rounded-lg text-sm border border-white/20">
            ...
            <div className="mt-12 bg-card rounded-xl p-8 border-2 border-border shadow-xl text-center">
                ...
                <div className="grid grid-cols-3 gap-4 text-sm mb-8">
                    <div className="p-3 bg-muted rounded border">Beacon for Courts</div>
                    <div className="p-3 bg-muted rounded border">Yardstick for Opposition</div>
                    <div className="p-3 bg-muted rounded border">Policy Stability</div>
                </div>
...
const SectionCompass = ({ title }: { title: string }) => (
    <div className="flex items-center gap-4 my-8">
        ...
        <div className="font-bold uppercase tracking-widest text-sm text-muted-foreground bg-card px-4 py-1 rounded-full border border-border shadow-sm">
            {title}
        </div>
        <div className="h-[2px] flex-1 bg-slate-300 border-t border-dashed border-slate-400"></div>
    </div>
