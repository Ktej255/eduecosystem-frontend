...
const ThinkCard = ({ title, children, color = "border-[#0f766e]", className = "" }: { title: string, children: React.ReactNode, color?: string, className?: string }) => (
    <div className={`bg-card border-2 ${color} rounded-2xl p-6 shadow-[6px_6px_0px_0px_rgba(15,118,110,0.1)] relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 ${className}`}>
...
export default function NITIAayogModule({ onComplete, isCompleted, chapterNumber = "56" }: NITIAayogModuleProps) {
    return (
        <ScrapbookContainer>
            {/* HERO SECTION */}
            <div className="relative bg-[#0f766e] border-4 border-slate-900 rounded-3xl p-8 md:p-12 shadow-[12px_12px_0px_0px_rgba(15,118,110,0.3)] overflow-hidden text-white">
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-4">
                        <Badge className="bg-[#ea580c] text-white px-4 py-1 text-lg border-2 border-white shadow-md">Chapter {chapterNumber}</Badge>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="p-3 bg-card border-2 border-slate-100 rounded-xl text-center shadow-sm">
                                <p className="text-[10px] font-black text-muted-foreground font-sans uppercase">Established [PYQ]</p>
                                <p className="text-sm font-black text-[#0f766e]">Jan 1, 2015</p>
                            </div>
                            <div className="p-3 bg-card border-2 border-slate-100 rounded-xl text-center shadow-sm">
                                <p className="text-[10px] font-black text-muted-foreground font-sans uppercase">Replaced</p>
                        ...
                        <div className="p-4 bg-slate-900 text-white rounded-2xl relative">
                            ...
                            <h4 className="text-xs font-black uppercase text-muted-foreground mb-2 font-sans">NATURE: [PYQ TRAP]</h4>
                ...
                <ThinkCard title="Guiding Principle (The Flip)" color="border-[#0f766e]">
                    <div className="flex flex-col items-center">
                        <div className="relative group perspective-1000">
                            <div className="w-48 h-32 bg-muted border-2 border-dashed border-slate-400 rounded-xl flex items-center justify-center flex-col p-4 mb-4">
                                <ArrowDownCircle className="text-muted-foreground mb-1" size={20} />
                                <p className="text-[10px] uppercase font-black text-muted-foreground">Old: Top-Down</p>
                                <p className="text-[8px] font-bold text-muted-foreground text-center uppercase">PC (Planning Commission)</p>
                            </div>
                            <div className="relative z-10 w-48 h-32 bg-teal-50 border-4 border-[#0f766e] rounded-xl flex items-center justify-center flex-col p-4 shadow-xl transform hover:-rotate-2 transition-transform">
                                ...
                                <p className="text-[8px] font-black text-muted-foreground text-center uppercase">States as Equal Partners</p>
                            </div>
                        </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <ThinkCard title="The Hierarchy" color="border-[#374151]">
                    <div className="space-y-4">
                        <div className="flex items-center gap-4 p-4 bg-muted border-2 border-border rounded-2xl">
                            <UserCheck className="text-[#374151]" size={32} />
                            <div>
                                <p className="text-xs font-black uppercase text-muted-foreground font-sans">Chairperson</p>
                        ...
                        <div className="p-4 bg-orange-50 border-2 border-[#ea580c] rounded-2xl">
                            ...
                            <ul className="space-y-2">
                                <li className="flex items-center gap-2 text-[11px] font-black italic shadow-sm bg-card p-2 rounded border border-orange-100">
                        ...
                        <div className="p-3 bg-muted border-2 border-dashed border-border rounded-xl">
                            <p className="text-[9px] font-black uppercase text-muted-foreground font-sans underline mb-1">Regional Councils:</p>
                            <p className="text-[10px] font-bold italic text-muted-foreground leading-tight">For specific issues affecting &gt;1 State. Chaired by PM or nominee.</p>
                        </div>
                    </div>
                </ThinkCard>
                    ...
                    <div className="grid grid-cols-1 gap-3">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-4 p-3 bg-teal-50 border border-teal-100 rounded-xl hover:border-[#0f766e] transition-colors group">
                                <div className="p-2 bg-card rounded-lg shadow-sm text-[#0f766e] group-hover:bg-[#0f766e] group-hover:text-white transition-colors">
                                    <org.i size={18} />
                                </div>
                                <div>
                                    <h5 className="text-[10px] font-black uppercase text-teal-800 font-sans tracking-tight">{org.t}</h5>
                                    <p className="text-[10px] font-bold text-muted-foreground italic leading-tight">{org.d}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <div className="bg-card border-4 border-slate-900 rounded-3xl overflow-hidden shadow-2xl relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                    <div className="p-8 border-b md:border-b-0 md:border-r border-border bg-muted relative">
                        <div className="absolute top-2 right-4 text-[40px] font-black text-slate-200 select-none">OLD</div>
                        <h4 className="text-xl font-black text-muted-foreground mb-6 italic">Planning Commission</h4>
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                <div className="w-1.5 h-1.5 bg-slate-300 rounded-full mt-2"></div>
                                <p className="text-[11px] font-bold text-muted-foreground italic leading-relaxed">Top-Down approach. States as spectators.</p>
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="w-1.5 h-1.5 bg-slate-300 rounded-full mt-2"></div>
                                <p className="text-[11px] font-bold text-muted-foreground italic leading-relaxed">Had power to <span className="text-red-600 underline">allocate funds</span> to States. [PYQ]</p>
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="w-1.5 h-1.5 bg-slate-300 rounded-full mt-2"></div>
                                <p className="text-[11px] font-bold text-muted-foreground italic leading-relaxed">Imposed policies on States (One size fits all).</p>
                            </li>
                        </ul>
                    </div>
                    <div className="p-8 bg-teal-50 relative border-l-4 border-teal-500 border-dashed">
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                ...
                                <p className="text-[11px] font-black text-foreground italic leading-relaxed">Bottom-Up approach. States as equal partners.</p>
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="w-1.5 h-1.5 bg-[#0f766e] rounded-full mt-2"></div>
                                <p className="text-[11px] font-black text-foreground italic leading-relaxed">NO power to allocate funds. (Only policy advisor). [HIGH YIELD]</p>
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="w-1.5 h-1.5 bg-[#0f766e] rounded-full mt-2"></div>
                                <p className="text-[11px] font-black text-foreground italic leading-relaxed">Platform for <span className="text-[#ea580c] font-black">National Development Agenda</span>.</p>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {["Pro-People", "Pro-Activity", "Participation", "Empowering", "Inclusion", "Equality", "Transparency"].map((p, i) => (
                                    <span key={i} className="px-3 py-1 bg-card/10 border border-white/20 rounded-full text-[10px] font-black uppercase italic">{p}</span>
                                ))}
                            </div>
                        </div>
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-1 gap-2">
                                <div className="flex items-center gap-3 bg-card/10 p-2 rounded-xl border border-white/20 group hover:bg-card/20 transition-all cursor-default">
            ...
            <div className="mt-16 text-center border-t-2 border-dashed border-border pt-12 pb-12 font-['Kalam']">
                ...
                <p className="mt-4 text-muted-foreground font-bold italic tracking-widest">National Institution for Transforming India.</p>
            </div>
        </ScrapbookContainer>
    );
}
