...
const ScrapbookContainer = ({ children }: { children: React.ReactNode }) => (
    <div className="bg-[#f1f5f9] min-h-screen p-4 md:p-8 font-['Kalam'] selection:bg-blue-100 selection:text-blue-900">
        <div className="max-w-6xl mx-auto space-y-12 bg-[url('https://www.transparenttextures.com/patterns/crumpled-paper.png')] bg-card/80 rounded-3xl p-6 shadow-2xl border-4 border-slate-900 relative overflow-hidden">
        ...
        <ScrapbookContainer>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <RightsCard title="PHR Act, 1993" color="border-[#374151]">
                    <div className="p-4 bg-muted border-2 border-dashed border-slate-400 rounded-2xl relative">
                ...
                <RightsCard title="The Head Table [PYQ]" color="border-[#1d4ed8]">
                    <div className="space-y-4">
                        <div className="p-4 bg-blue-50 border-2 border-[#1d4ed8] rounded-xl transform rotate-1">
                            ...
                            <p className="text-sm font-black italic">Retd. CJI OR SC Judge. <span className="text-[10px] text-muted-foreground font-sans tracking-tighter">(2019 Change)</span></p>
                        </div>
                        <div className="grid grid-cols-1 gap-2">
                            {[
                                ...
                                <div key={i} className="flex items-center gap-3 bg-card p-2 rounded border border-slate-100 shadow-sm">
            ...
            <div className="bg-card border-2 border-slate-900 rounded-3xl p-8 shadow-xl relative overflow-hidden">
                <div className="absolute top-0 left-0 w-2 h-full bg-[#1d4ed8]"></div>
                <h4 className="text-xl font-black mb-6 italic flex items-center gap-2 text-foreground uppercase tracking-tighter">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                    {[
                        ...
                        <div key={i} className="flex flex-col items-center group">
                            ...
                            <p className="text-[8px] font-bold text-muted-foreground italic">{m.d}</p>
                        </div>
                    ))}
                </div>
                ...
                <RightsCard title="Investigative Scope" color="border-[#1d4ed8]">
                    <div className="space-y-4">
                        ...
                        <div className="p-4 bg-card border-2 border-slate-900 rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                            <h4 className="text-[10px] font-black uppercase text-muted-foreground mb-2 italic">Civil Court Powers:</h4>
                        ...
                        <div className="flex items-center gap-3 p-3 bg-muted rounded-xl border border-border italic">
                ...
                <RightsCard title="The 'Toothless' Muzzle" color="border-[#b91c1c]">
                    <div className="p-1 border-4 border-[#b91c1c] rounded-3xl overflow-hidden relative group">
                        ...
                        <div className="relative p-6 space-y-4">
                            ...
                            <ul className="space-y-3">
                                <li className="p-2 bg-card rounded-lg shadow-sm border-l-4 border-[#b91c1c] text-[11px] font-bold italic">
            ...
            <div className="bg-[#b91c1c] text-white border-4 border-black rounded-3xl p-8 relative overflow-hidden shadow-2xl">
                ...
                <div className="flex flex-col md:flex-row items-center gap-12 relative z-10">
                    <div className="text-center">
                        <div className="w-24 h-24 bg-card rounded-full flex items-center justify-center shadow-xl rotate-12 transition-transform hover:rotate-0">
                    ...
                    <div className="flex-1 space-y-4">
                        ...
                        <p className="text-lg font-bold leading-relaxed italic opacity-95">
                            NHRC <span className="text-black font-black bg-card px-2">CANNOT</span> inquire into any matter after one year from the date of occurrence. [PYQ Trap]
                        </p>
            ...
            {/* FOOTER: SHRC */}
            <div className="p-12 border-4 border-dashed border-border rounded-[50px] text-center bg-muted relative">
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-card px-8 py-2 border-2 border-slate-900 rounded-full font-black text-sm uppercase">State Mirror Preview</div>
                <h4 className="text-2xl font-black italic text-foreground mb-4 underline decoration-[#1d4ed8]">State Human Rights Commission (SHRC)</h4>
                <div className="flex flex-col md:flex-row justify-center gap-12 items-center">
                    <div className="space-y-1">
                        <p className="text-[10px] font-black uppercase text-muted-foreground">Chair</p>
            ...
            <div className="mt-16 text-center border-t-4 border-slate-900 pt-12 pb-12 font-['Kalam']">
                ...
                <p className="mt-4 text-muted-foreground font-bold italic underline decoration-[#b91c1c] tracking-widest">A Protection of Rights Scroll.</p>
            </div>
        </ScrapbookContainer>
    );
}
