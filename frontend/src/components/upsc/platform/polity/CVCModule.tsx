...
const WatchtowerCard = ({ title, children, color = "border-[#1e3a8a]", className = "" }: { title: string, children: React.ReactNode, color?: string, className?: string }) => (
    <div className={`bg-card border-2 ${color} rounded-2xl p-6 shadow-[6px_6px_0px_0px_rgba(30,58,138,0.1)] relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 ${className}`}>
        ...
        <ScrapbookContainer>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <WatchtowerCard title="Historical Roots [PYQ]" color="border-[#ca8a04]">
                    <div className="space-y-6 relative border-l-2 border-dashed border-border ml-4 pl-6">
                        <div className="relative">
                            <div className="absolute -left-8 top-1 w-4 h-4 rounded-full bg-[#1e3a8a] border-4 border-white shadow-md"></div>
                            <p className="text-[10px] font-black uppercase text-muted-foreground">1964</p>
                        ...
                        <div className="relative">
                            ...
                            <p className="text-[10px] font-black uppercase text-muted-foreground">2003</p>
                            <p className="text-sm font-black italic">Conferred STATUTORY Status. [PYQ]</p>
                            <p className="text-[9px] font-bold text-muted-foreground italic">By CVC Act, 2003.</p>
                        </div>
                    </div>
                </WatchtowerCard>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <WatchtowerCard title="The Commission" color="border-slate-800">
                    <div className="space-y-4">
                        <div className="flex gap-4 items-center p-4 bg-muted border-2 border-border rounded-2xl transform hover:scale-105 transition-transform">
                            <UserCheck className="text-foreground" size={32} />
                            <div>
                                <h4 className="text-[10px] font-black uppercase text-muted-foreground">Structure:</h4>
                ...
                <WatchtowerCard title="Appointment Committee" color="border-[#1e3a8a]">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-4 p-3 bg-card border border-slate-100 rounded-xl hover:shadow-md transition-shadow group">
            ...
            <div className="bg-card border-4 border-slate-900 rounded-[40px] p-8 shadow-2xl relative overflow-hidden group">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex gap-3 p-3 bg-muted border-2 border-dashed border-border rounded-xl">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="p-4 border-2 border-[#1e3a8a] rounded-2xl bg-card text-center">
                            <h5 className="text-[10px] font-black uppercase text-muted-foreground mb-1 tracking-widest">Whistleblowers Act (2014) [FYI]</h5>
            ...
            <div className="p-8 border-4 border-dashed border-[#ca8a04] rounded-[30px] bg-yellow-50/50 relative text-center group">
                ...
                <p className="text-sm font-bold leading-relaxed italic text-blue-900">
                    By <span className="text-black font-black bg-card px-2 rounded border border-black shadow-sm">PRESIDENT</span>. <br />
            ...
            <div className="mt-16 text-center border-t-2 border-dashed border-border pt-12 pb-12 font-['Kalam']">
                ...
                <p className="mt-4 text-muted-foreground font-bold italic tracking-widest">CVC Act, 2003: Integrity is the Foundation.</p>
            </div>
        </ScrapbookContainer>
    );
}
