...
const ScrapbookContainer = ({ children }: { children: React.ReactNode }) => (
    <div className="bg-[#f3f4f6] min-h-screen p-4 md:p-8 font-['Kalam'] selection:bg-teal-100">
        <div className="max-w-4xl mx-auto space-y-12 bg-[url('https://www.transparenttextures.com/patterns/crumpled-paper.png')] bg-card/60 rounded-3xl p-6 shadow-xl border-2 border-border relative overflow-hidden">
            {children}
        </div>
    </div>
);
...
const SentinelCard = ({ title, children, color = "border-teal-700", className = "" }: { title: string, children: React.ReactNode, color?: string, className?: string }) => (
    <div className={`bg-card border-2 ${color} rounded-2xl p-6 shadow-[4px_4px_0px_0px_rgba(15,118,110,0.1)] relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 ${className}`}>
    ...
    return (
        <ScrapbookContainer>
            ...
            <div className="relative bg-[#0f766e] border-4 border-slate-900 rounded-3xl p-8 md:p-12 shadow-[10px_10px_0px_0px_rgba(15,118,110,0.3)] overflow-hidden text-white">
                <div className="absolute top-0 right-0 w-64 h-64 bg-card/5 rounded-full -mr-32 -mt-32 blur-3xl"></div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <SentinelCard title="The 7th Amendment (1956)" color="border-[#374151]">
                    <div className="space-y-4">
                        <div className="p-4 bg-[#f3f4f6] border-2 border-dashed border-[#374151] rounded-xl relative">
                            ...
                            <p className="text-xs font-black text-muted-foreground leading-relaxed italic mt-2">
                        ...
                        <div className="p-4 bg-card border-2 border-[#0f766e] rounded-xl text-center shadow-sm">
                            <h4 className="font-black text-[#0f766e] text-lg">Article 350-B</h4>
                            <p className="text-[10px] uppercase font-black text-muted-foreground">Inserted in Part XVII</p>
                        </div>
                    </div>
                </SentinelCard>
                ...
                <SentinelCard title="Appointment & Profile" color="border-[#0f766e]">
                    <div className="space-y-4">
                        <div className="flex items-center gap-4 p-4 bg-muted border-2 border-border rounded-2xl relative">
                        ...
                        <div className="p-4 bg-card border-2 border-dashed border-red-200 rounded-xl relative overflow-hidden">
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                {["Belgaum", "Chennai", "Kolkata"].map((city, i) => (
                                    <div key={i} className="bg-muted p-2 rounded border border-slate-100 text-center">
                                        <p className="text-[8px] font-black text-muted-foreground">{city}</p>
                                    </div>
                                ))}
                            </div>
                            <p className="text-[8px] text-center mt-2 text-muted-foreground font-bold uppercase">(Regional Offices)</p>
                        </div>
                    </div>
                </SentinelCard>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <SentinelCard title="Duties (Art 350-B)" color="border-[#0f766e]">
                    <div className="space-y-4 p-4 bg-teal-50/50 rounded-2xl border-2 border-dashed border-teal-200 relative">
                        <div className="absolute top-2 right-2 p-2 bg-card rounded-lg shadow-sm border border-teal-100 flex items-center justify-center">
                    ...
                    <div className="space-y-6 flex flex-col items-center py-4">
                        <div className="flex items-center gap-3 w-full justify-between px-4">
                            <div className="flex flex-col items-center">
                                <div className="p-3 bg-card border-2 border-slate-800 rounded shadow-sm"><UserCheck size={24} /></div>
                        ...
                        <div className="grid grid-cols-2 gap-4 w-full">
                            <div className="p-3 bg-muted border border-border rounded-xl text-center shadow-sm hover:bg-card transition-colors">
                                <FileText size={20} className="mx-auto text-muted-foreground mb-1" />
                                <p className="text-[9px] font-black uppercase text-foreground">Parliament</p>
                                <p className="text-[8px] text-muted-foreground italic">(Laid before both Houses)</p>
                            </div>
                            <div className="p-3 bg-muted border border-border rounded-xl text-center shadow-sm hover:bg-card transition-colors">
                                <Map size={20} className="mx-auto text-muted-foreground mb-1" />
                                <p className="text-[9px] font-black uppercase text-foreground">Governor</p>
                                <p className="text-[8px] text-muted-foreground italic">(Sent to state Govts)</p>
                            </div>
                        </div>
                    </div>
                </SentinelCard>
            ...
            <div className="grid md:grid-cols-1 gap-8">
                <SentinelCard title="The Mission" color="border-[#0f766e]" className="bg-teal-50/20">
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                        <div className="w-32 h-32 shrink-0 bg-card border-4 border-dashed border-[#0f766e] rounded-full flex flex-col items-center justify-center text-[#0f766e] p-4 text-center">
                            <BadgeCheck size={32} />
                        ...
                        <div className="grid md:grid-cols-3 gap-4 flex-1">
                            {[
                                ...
                                <div key={i} className="p-4 bg-card border border-teal-100 rounded-2xl shadow-sm group hover:border-[#0f766e] transition-colors">
                                    <h5 className="text-[10px] font-black text-[#0f766e] uppercase mb-1">{obj.t}</h5>
                                    <p className="text-[11px] font-bold text-muted-foreground leading-relaxed italic">{obj.d}</p>
                                </div>
                            ))}
                        </div>
                    </div>
            ...
            <div className="bg-[#374151] text-white border-4 border-slate-900 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
                    <div className="w-20 h-20 bg-card/10 rounded-2xl flex items-center justify-center shrink-0 backdrop-blur-sm border border-white/20">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-xs font-black text-[#0f766e] bg-card px-3 py-1 rounded inline-block">
            ...
            <div className="mt-16 text-center border-t-2 border-dashed border-border pt-12 pb-12 font-['Kalam']">
                ...
                <p className="mt-4 text-muted-foreground font-bold italic">Signed: Article 350-B.</p>
            </div>
        </ScrapbookContainer>
    );
}
