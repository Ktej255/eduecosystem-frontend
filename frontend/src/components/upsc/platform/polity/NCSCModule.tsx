...
const HandwrittenCard = ({ title, children, color = "border-indigo-800", className = "" }: { title: string, children: React.ReactNode, color?: string, className?: string }) => (
    <div className={`bg-card border-2 ${color} rounded-2xl p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,0.1)] relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 ${className}`}>
        <div className="absolute top-0 right-0 w-16 h-16 bg-muted -mr-8 -mt-8 rounded-full border border-slate-100 italic flex items-end justify-start pl-2 pb-2 text-[10px] text-slate-300">SC</div>
        ...
        <ScrapbookContainer>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <HandwrittenCard title="The Timeline [High Yield]" color="border-[#c2410c]">
                    <div className="relative pl-8 space-y-8 before:absolute before:left-3 before:top-2 before:bottom-2 before:w-1 before:bg-muted before:border-l-2 before:border-dashed before:border-orange-200">
                        <div className="relative">
                            <div className="absolute -left-[26px] top-1 w-4 h-4 rounded-full bg-card border-4 border-[#1e40af]"></div>
                            <h4 className="font-black text-[#1e40af]">1950 - Original Constitution</h4>
                            <p className="text-xs font-bold text-muted-foreground italic">Article 338 provided for a Special Officer for SCs & STs.</p>
                        </div>
                        <div className="relative">
                            <div className="absolute -left-[26px] top-1 w-4 h-4 rounded-full bg-card border-4 border-[#1e40af]"></div>
                            <h4 className="font-black text-[#1e40af]">1990 - 65th Amendment [PYQ]</h4>
                            <p className="text-xs font-bold text-muted-foreground italic">Replaced Special Officer with a Multi-Member Commission for SCs & STs.</p>
                        </div>
                        <div className="relative p-3 bg-orange-50 border-2 border-dashed border-[#c2410c] rounded-xl transform -rotate-1">
                            <div className="absolute -left-[31px] top-4 w-6 h-6 rounded-full bg-card border-4 border-[#c2410c] flex items-center justify-center">
                                <Share2 size={10} className="text-[#c2410c]" />
                            </div>
                            <h4 className="font-black text-[#c2410c]">2003 - 89th Amendment [CRITICAL]</h4>
                            <p className="text-xs font-black text-muted-foreground">Bifurcation into two distinct bodies:</p>
                ...
                <HandwrittenCard title="Composition (The Team)" color="border-[#1e40af]">
                    <div className="bg-muted p-6 rounded-2xl border-4 border-double border-border">
                        <div className="grid grid-cols-3 gap-2 mb-6">
                            <div className="text-center p-2 bg-card border-2 border-[#1e40af] rounded-lg shadow-sm">
                            ...
                            <div className="text-center p-2 bg-card border-2 border-indigo-200 rounded-lg shadow-sm">
                            ...
                            <div className="text-center p-2 bg-card border-2 border-indigo-100 rounded-lg shadow-sm">
                                <Users className="mx-auto text-indigo-200" size={20} />
                                <p className="text-[10px] font-black mt-1">3 Members</p>
                            </div>
                        </div>
                        <div className="space-y-4">
                            <div className="flex items-center gap-3 p-3 bg-card rounded-xl border-2 border-[#ca8a04]">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <HandwrittenCard title="Duties (Art 338)" color="border-[#1e40af]">
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={i} className="flex gap-4 p-3 bg-muted rounded-xl border border-slate-100 items-start">
                ...
                <HandwrittenCard title="The Anglo-Indian Link [Trap Alert]" color="border-[#ca8a04]">
                    <div className="p-6 bg-[#fffbeb] border-4 border-double border-[#ca8a04] rounded-2xl relative">
                        ...
                        <div className="mt-6 p-4 bg-card/80 rounded-xl border-2 border-dashed border-[#4b5563]">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <HandwrittenCard title="Civil Court Powers" color="border-slate-950" className="bg-muted shadow-[10px_10px_0px_0px_rgba(0,0,0,1)]">
                    <div className="flex gap-4 items-start mb-6">
                        <div className="w-16 h-16 bg-card border-2 border-slate-900 rounded-2xl flex items-center justify-center shrink-0 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                            <Gavel size={32} className="text-foreground" />
                        </div>
                        <div>
                            <p className="text-xs font-black uppercase tracking-widest text-muted-foreground">Judicial Status</p>
                ...
                <HandwrittenCard title="Mandatory Consultation" color="border-[#1e40af]">
                    <div className="text-center p-8 bg-card border-4 border-[#1e40af] border-dashed rounded-3xl group-hover:bg-indigo-50 transition-colors">
            ...
            <div className="bg-[#4b5563] text-white border-4 border-slate-900 rounded-3xl p-8 relative overflow-hidden shadow-2xl">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
                    <div className="flex flex-col items-center gap-2">
                        <div className="w-20 h-24 bg-card border-2 border-border rounded shadow-inner rotate-3 flex items-center justify-center p-2">
                    ...
                    <div className="flex-1 grid grid-cols-2 gap-4 w-full md:w-auto">
                        <div className="p-3 bg-card/10 border border-white/20 rounded-xl text-center">
            ...
            <div className="mt-16 text-center border-t-2 border-dashed border-border pt-12 pb-12">
                ...
                <p className="mt-4 text-muted-foreground font-bold">The Shield of Article 338.</p>
            </div>
        </ScrapbookContainer>
    );
}
