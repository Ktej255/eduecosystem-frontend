...
const ScrapbookContainer = ({ children }: { children: React.ReactNode }) => (
    <div className="bg-[#f0f9ff] min-h-screen p-4 md:p-8 font-['Kalam'] selection:bg-blue-200">
        <div className="max-w-6xl mx-auto space-y-12 bg-[url('https://www.transparenttextures.com/patterns/crumpled-paper.png')] bg-card/80 rounded-3xl p-6 shadow-2xl border-4 border-blue-900 relative overflow-hidden">
...
const SearchlightCard = ({ title, children, color = "border-[#1d4ed8]", className = "" }: { title: string, children: React.ReactNode, color?: string, className?: string }) => (
    <div className={`bg-card border-2 ${color} rounded-2xl p-6 shadow-[6px_6px_0px_0px_rgba(29,78,216,0.1)] relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 ${className}`}>
...
export default function CICModule({ onComplete, isCompleted, chapterNumber = "62" }: CICModuleProps) {
    return (
        <ScrapbookContainer>
            {/* HERO SECTION */}
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <SearchlightCard title="The RTI Act (2005)" color="border-[#1d4ed8]">
                    <div className="p-4 bg-blue-50 border-2 border-dashed border-blue-400 rounded-2xl relative overflow-hidden group">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="text-[10px] font-black text-muted-foreground text-center uppercase tracking-tighter italic">Not under Home Ministry!</li>
                        </ul>
                    </div>
                </SearchlightCard>
                ...
                <SearchlightCard title="Composition (1 + 10)" color="border-slate-800">
                    <div className="space-y-4">
                        <div className="p-4 bg-card border-2 border-slate-900 rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                            <h4 className="text-[10px] font-black uppercase text-muted-foreground mb-1">Structure:</h4>
            ...
            <div className="bg-card border-2 border-blue-950 rounded-[40px] p-8 shadow-2xl relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        <div key={i} className="flex gap-4 items-center p-4 bg-muted border border-slate-100 rounded-2xl group transition-all hover:bg-card hover:shadow-md">
                            ...
                            <div>
                                ...
                                <p className="text-[9px] font-bold text-muted-foreground italic">{m.d}</p>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <div className="bg-[#b91c1c] text-white border-4 border-slate-900 rounded-3xl overflow-hidden shadow-2xl relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="p-8 bg-card text-foreground relative border-l-4 border-white border-dashed">
                        <div className="flex items-center gap-3 mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <SearchlightCard title="Quasi-Judicial Powers" color="border-blue-900">
                    <div className="space-y-4">
                        <div className="p-4 bg-card border-2 border-slate-900 rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                ...
                <SearchlightCard title="The Bite (Penalties)" color="border-[#c2410c]">
                    <div className="space-y-4">
                        <div className="p-6 bg-orange-50 border-l-8 border-[#c2410c] rounded-2xl shadow-xl transform rotate-1 group hover:rotate-0 transition-transform">
                            ...
                            <p className="text-[11px] font-bold text-foreground italic leading-snug mb-4">
                                On Public Information Officer (PIO) for unreasonable delay.
                            </p>
                            <div className="flex gap-4">
                                <div className="p-3 bg-card border-2 border-[#c2410c] rounded-xl flex-1 text-center group-hover:scale-105 transition-transform">
                                    <p className="text-[8px] font-black text-muted-foreground font-sans uppercase">Per Day</p>
                                    <p className="text-xl font-black text-[#c2410c]">₹250</p>
                                </div>
                                <div className="p-3 bg-card border-2 border-[#c2410c] rounded-xl flex-1 text-center group-hover:scale-105 transition-transform">
                                    <p className="text-[8px] font-black text-muted-foreground font-sans uppercase">Maximum [PYQ]</p>
                                    <p className="text-xl font-black text-[#c2410c]">₹25,000</p>
                                </div>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 p-3 bg-muted border border-border rounded-xl italic">
            ...
            <div className="p-8 border-4 border-dashed border-red-200 rounded-[30px] bg-red-50 relative overflow-hidden text-center group">
                <div className="absolute inset-0 bg-card/50 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="relative z-10">
                    ...
                    <p className="text-[9px] font-black text-muted-foreground mt-4 uppercase tracking-tighter">Reference to SC is mandatory for Misbehavior grounds.</p>
                </div>
            </div>
            ...
            <div className="mt-16 text-center border-t-4 border-blue-900 pt-12 pb-12 font-['Kalam']">
                ...
                <p className="mt-4 text-muted-foreground font-bold italic tracking-widest">RTI Act, 2005: The Power of Information.</p>
            </div>
        </ScrapbookContainer>
    );
}
