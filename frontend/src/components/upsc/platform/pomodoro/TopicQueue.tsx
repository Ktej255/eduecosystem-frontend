...
export default function TopicQueue({
    ...
    return (
        <Card className="border-orange-200 dark:border-orange-800 bg-card">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                {index === 0 ? (
                                    ...
                                    <div className="w-6 h-6 rounded-full bg-gray-300 text-muted-foreground dark:text-muted-foreground flex items-center justify-center text-xs font-bold">
                                        {index + 1}
                                    </div>
                                )}
                                <div>
                                    <div className={`font-medium ${index === 0 ? 'text-orange-700 dark:text-orange-300' : 'text-muted-foreground dark:text-muted-foreground'}`}>
                                        {topic.name}
                                    </div>
                            ...
                            <Button
                                ...
                                className={`${index === 0
                                    ...
                                    : 'bg-muted hover:bg-gray-300 text-muted-foreground'
                                    }`}
                            >
