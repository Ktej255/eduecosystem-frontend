import { HISTORY_SCHEDULE, HISTORY_START_DATE, HistoryDaySchedule } from '../../subjects/history/data/history-schedule-data';
...
export function getFabDayContent(currentDate: Date = new Date()): FabDayContent | null {
    ...
    // Morning: History
    const historySch = HISTORY_SCHEDULE.find((d: HistoryDaySchedule) => d.day === currentDayNum) || null;
