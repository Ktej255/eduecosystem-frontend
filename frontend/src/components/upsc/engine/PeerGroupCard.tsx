...
export default function PeerGroupCard() {
    return (
        <div className="relative overflow-hidden rounded-xl border border-border bg-card dark:bg-[#111] p-6 group">
            {/* Locked Overlay */}
            <div className="absolute inset-0 bg-gray-900/5 dark:bg-black/50 backdrop-blur-[2px] flex flex-col items-center justify-center z-10 p-6 text-center">
                ...
                <h3 className="font-bold text-foreground mb-1">Level 3: Study Circles Locked</h3>
            ...
            <div className="opacity-40 blur-sm pointer-events-none select-none">
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="font-bold text-foreground">Toppers Batch (100)</h3>
                ...
                <div className="space-y-3">
                    <div className="flex gap-3">
                        ...
                        <div className="bg-muted p-2 rounded-lg rounded-tl-none text-xs w-3/4">
