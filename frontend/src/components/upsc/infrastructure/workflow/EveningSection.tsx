    ...
    return (
        <div className="max-w-4xl mx-auto py-8 space-y-8 animate-in fade-in slide-in-from-right">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Flashcards */}
                <Card className="hover:shadow-lg transition-all cursor-pointer border-blue-200 bg-blue-50 dark:bg-blue-950/20" onClick={() => handleNavigate('/student/upsc/polity/revision')}>
                    <CardHeader>
                ...
                {/* MCQs */}
                <Card className="hover:shadow-lg transition-all cursor-pointer border-green-200 bg-green-50 dark:bg-green-950/20" onClick={() => handleNavigate('/student/upsc/polity/revision/quick')}>
                ...
                {/* CSAT */}
                <Card className="hover:shadow-lg transition-all cursor-pointer border-purple-200 bg-purple-50 dark:bg-purple-950/20" onClick={() => handleNavigate('/student/upsc/csat')}>
                    <CardHeader>
