...
import SubjectVisualizer from './visualizations/DiplomacyGraph';
                ...
                {activeTab === 'flashcards' && (
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 py-8">
                        <div className="max-w-4xl mx-auto mb-8 text-center">
                            ...
                            <p className="text-muted-foreground">Foreign Policy, International Organizations, and key bilateral relations.</p>
                        </div>
