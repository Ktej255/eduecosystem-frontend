                    ...
                    {chaptersWithMCQs.map((chapter: HistoryChapter & { mcqCount: number }) => (
                        ...
                        >
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                <button
                                    onClick={() => router.push(`/student/upsc/history/mcq?chapter=${chapter.id}&section=${activeSection}&level=1`)}
                                ...
                                <button
                                    onClick={() => router.push(`/student/upsc/history/mcq?chapter=${chapter.id}&section=${activeSection}&level=2`)}
                                ...
                                <button
                                    onClick={() => router.push(`/student/upsc/history/mcq?chapter=${chapter.id}&section=${activeSection}&level=3`)}
