...
export default function PolityUnifiedDashboard({ registryMode }: { registryMode?: string }) {
    ...
    const navigateToTopic = (topicId: number) => {
        router.push(`/student/upsc/polity/${topicId}`);
    };
    ...
    const handleAction = (e: React.MouseEvent, type: 'flashcard' | 'mcq' | 'report', topicId: number) => {
        ...
        if (type === 'flashcard') {
            ...
            router.push(`/student/upsc/polity/${topicId}/flashcards`);
        } else if (type === 'mcq') {
            updateTopicProgress(topicId, { mcqsDone: true });
            router.push(`/student/upsc/polity/${topicId}/mcq`);
        } else if (type === 'report') {
        ...
        <div className="space-y-6 max-w-7xl mx-auto p-4 md:p-6 pb-24">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                ...
                <div className="flex gap-2 flex-wrap justify-end">
                    ...
                    <Button
                        size="sm"
                        onClick={() => router.push('/student/upsc/polity/ai-tutor')}
                    ...
                    <Button
                        size="sm"
                        onClick={() => router.push('/student/upsc/polity/verdict-visualizer')}
                    ...
                    <Button
                        size="sm"
                        onClick={() => router.push('/student/upsc/polity/preamble-prism')}
                    ...
                    <Button
                        size="sm"
                        onClick={() => router.push('/student/upsc/current-affairs?subject=Polity')}
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="grid grid-cols-7 gap-1 pt-3 border-t border-border">
                                                    ...
                                                    {/* 6. Current Affairs */}
                                                    <button
                                                        onClick={(e) => { e.stopPropagation(); router.push(`/student/upsc/polity/${topic.id}/current-affairs`); }}
                ...
                onAction={(type) => {
                    if (selectedReportTopic) {
                        if (type === 'read') navigateToTopic(selectedReportTopic);
                            ...
                            if (type === 'flashcard') router.push(`/student/upsc/polity/${selectedReportTopic}/flashcards`);
                            if (type === 'mcq') router.push(`/student/upsc/polity/${selectedReportTopic}/mcq`);
                        }
