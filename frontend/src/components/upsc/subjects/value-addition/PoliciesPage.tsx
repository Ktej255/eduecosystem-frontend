        ...
        <div className="p-4 max-w-7xl mx-auto space-y-6 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {POLICIES_DATA.map((policy) => (
                    <Card key={policy.id} className="hover:shadow-lg transition-all duration-300 border-t-4 border-t-violet-500 bg-card">
                        <CardHeader className="pb-3">
                            ...
                            <CardDescription className="flex items-center gap-1 text-muted-foreground dark:text-muted-foreground">
