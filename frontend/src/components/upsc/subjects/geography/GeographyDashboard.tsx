...
export default function GeographyDashboard() {
    ...
    const handleStartSession = (topic: GeographyTopic) => {
        ...
        router.push(`/student/upsc/geography/session?block=${topic.blockId}&branch=${topic.branch}`);
    };
        ...
        <div className="max-w-7xl mx-auto px-4 py-8 space-y-8 min-h-screen">
            ...
            {viewMode === 'sheet' ? (
                <div className="space-y-6">
                    ...
                    <Card className="border-none shadow-lg bg-gradient-to-r from-indigo-900 to-slate-900 overflow-hidden relative cursor-pointer group" onClick={() => router.push('/student/upsc/geography/saturday-test')}>
