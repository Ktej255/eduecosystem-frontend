...
export default function VoiceCommandListener() {
    ...
    const processCommand = (text: string) => {
        ...
        if (text.includes("dashboard") || text.includes("home")) {
            ...
            router.push('/student/batch1-1/productivity');
