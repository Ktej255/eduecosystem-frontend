...
const ScrapbookContainer = ({ children }: { children: React.ReactNode }) => (
    <div className="bg-[#f0fdf4] min-h-screen p-4 md:p-8 font-['Kalam'] selection:bg-green-100 selection:text-green-900">
        <div className="max-w-6xl mx-auto space-y-12 bg-[url('https://www.transparenttextures.com/patterns/crumpled-paper.png')] bg-white/90 rounded-[40px] p-6 shadow-2xl border-4 border-green-800 relative overflow-hidden">
...
const SpotlightCard = ({ title, children, color = "border-[#15803d]", className = "" }: { title: string, children: React.ReactNode, color?: string, className?: string }) => (
    <div className={`bg-white border-2 ${color} rounded-2xl p-6 shadow-[6px_6px_0px_0px_rgba(21,128,61,0.1)] relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 ${className}`}>
...
export default function SICModule({ onComplete, isCompleted, chapterNumber = "63" }: SICModuleProps) {
    return (
        <ScrapbookContainer>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <SpotlightCard title="State Composition (1 + 10)" color="border-[#15803d]">
                    <div className="space-y-4">
                        ...
                        <div className="p-3 bg-white border-2 border-slate-900 rounded-xl relative shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                            <h4 className="text-[9px] font-black uppercase text-slate-400 mb-1">Eminence Qualification:</h4>
            ...
            <div className="bg-white border-4 border-green-800 rounded-[50px] p-8 shadow-2xl relative overflow-hidden text-center">
            ...
            <div className="bg-[#dc2626] text-white border-4 border-slate-900 rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10 space-y-8">
                    ...
                    <p className="text-sm font-bold opacity-90 italic max-w-2xl leading-relaxed">
                        The 2019 Amendment ensures that the <span className="text-black font-black bg-white px-1">CENTRAL GOVERNMENT</span> now determines the tenure and salary of State Information Commissioners as well. [CRITICAL]
                    </p>
            ...
            <div className="grid md:grid-cols-1 gap-8">
                <SpotlightCard title="Removal vs SHRC [CRITICAL TRAP]" color="border-[#c2410c]" className="bg-orange-50">
                    <div className="flex flex-col md:flex-row items-center gap-12">
                        <div className="p-6 bg-white border-2 border-slate-900 rounded-3xl shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden group">
                            <div className="absolute top-0 right-0 p-2 opacity-5"><ShieldAlert size={64} /></div>
                            <h4 className="text-lg font-black text-slate-800 mb-2 italic">SIC Removal:</h4>
                            <p className="text-3xl font-black text-[#c2410c] flex items-center gap-4">
                                GOVERNOR <BadgeCheck className="text-green-600" size={32} />
                            </p>
                            <p className="text-[10px] font-black text-slate-500 mt-2 italic shadow-sm bg-slate-50 p-1 rounded inline-block">After SC Inquiry. [PYQ]</p>
                        </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <SpotlightCard title="Regional Bite" color="border-[#c2410c]">
                    <div className="space-y-4">
                        <div className="p-4 bg-white border-2 border-[#15803d] rounded-2xl relative group overflow-hidden">
                            <div className="absolute inset-0 bg-green-50 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            <div className="relative flex justify-between items-center">
                                <div>
                                    <h4 className="text-[10px] font-black uppercase text-slate-400">Per Day Fine:</h4>
                        ...
                        <p className="text-[10px] font-bold italic text-slate-500">Can order compensation for loss to applicant.</p>
                    </div>
                </SpotlightCard>
                ...
                <SpotlightCard title="Powers Recap" color="border-[#15803d]">
                    <ul className="space-y-3">
                        {[
                            ...
                            <li key={i} className="flex gap-3 items-center p-3 bg-slate-50 rounded-xl border border-slate-100 italic transition-transform hover:translate-x-1">
            ...
            <div className="mt-16 text-center border-t-4 border-green-800 pt-12 pb-12 font-['Kalam']">
                ...
                <p className="mt-4 text-slate-400 font-bold italic tracking-widest text-[11px] uppercase">RTI Act, 2005: The Regional Searchlight.</p>
            </div>
        </ScrapbookContainer>
    );
}
