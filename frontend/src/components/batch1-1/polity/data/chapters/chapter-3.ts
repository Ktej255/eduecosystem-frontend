    ...
    levels: [
        {
            ...
            description: "Strictly Chapter 3: Direct Recall.",
            questions: LEVEL_1_QUESTIONS.map((q, i) => ({ ...q, id: `ch3-l1-q${i + 1}` }))
        },
        {
            levelId: 2,
            title: "Conceptual Bridge",
            description: "Applied Knowledge & Analysis.",
            questions: LEVEL_2_QUESTIONS.map((q, i) => ({ ...q, id: `ch3-l2-q${i + 1}` }))
        },
        {
            levelId: 3,
            title: "UPSC Simulation",
            description: "Integrated & Current Affairs Context.",
            questions: LEVEL_3_QUESTIONS.map((q, i) => ({ ...q, id: `ch3-l3-q${i + 1}` }))
        }
    ]
};
