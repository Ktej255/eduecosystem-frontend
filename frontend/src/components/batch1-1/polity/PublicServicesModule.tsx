...
const BureaucratCard = ({ title, children, color = "border-[#374151]", className = "" }: { title: string, children: React.ReactNode, color?: string, className?: string }) => (
    <div className={`bg-white border-2 ${color} rounded-2xl p-6 shadow-[8px_8px_0px_0px_rgba(55,65,81,0.1)] relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 ${className}`}>
...
export default function PublicServicesModule({ onComplete, isCompleted, chapterNumber = "75" }: PublicServicesModuleProps) {
    return (
        <ScrapbookContainer>
            ...
            <div className="relative group p-10 bg-slate-50 border-4 border-[#374151] border-dashed rounded-[3rem] shadow-xl overflow-hidden">
                ...
                <div className="max-w-3xl mx-auto space-y-12 relative z-10">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-6 bg-slate-100 text-[#374151] rounded-2xl border-4 border-[#374151] text-center shadow-lg transform hover:scale-105 transition-transform w-[80%] mx-auto">
                    ...
                    <div className="mt-8 p-6 bg-white border-4 border-[#ca8a04] rounded-3xl relative overflow-hidden shadow-xl italic">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <BureaucratCard title="The Rule of Pleasure" color="border-slate-800">
                    <div className="p-5 bg-slate-50 border-x-4 border-slate-600 rounded-3xl relative overflow-hidden group italic">
                        <BadgeCheck className="absolute top-0 right-0 p-2 opacity-10 text-slate-600" size={40} />
                        <h4 className="font-black text-slate-700 uppercase text-xs mb-4">Principle</h4>
            ...
            <div className="relative p-10 bg-white border-4 border-[#ca8a04] rounded-[3rem] shadow-xl overflow-hidden group">
                ...
                <div className="relative z-10 space-y-6">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 pt-4">
                        {['UPSC (AIS & Group A/B)', 'SPSC (State Services)', 'SSC (Lower-level Central)'].map(agency => (
                            <Badge key={agency} className="px-6 py-2 bg-white/10 border-2 border-white/20 text-lg hover:bg-[#ca8a04]/20 transition-colors">
                                {agency}
                            </Badge>
                        ))}
                    </div>
            ...
            <div className="mt-16 text-center border-t-4 border-[#374151] pt-12 pb-12 font-['Kalam']">
                ...
                <p className="mt-4 text-slate-400 font-bold italic tracking-widest text-center uppercase">Classification • Safeguards • Merit.</p>
            </div>
        </ScrapbookContainer>
    );
}
