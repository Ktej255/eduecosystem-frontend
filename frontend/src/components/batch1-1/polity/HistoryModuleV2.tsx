...
const V2Stamp = ({ children, type = "default" }: { children: React.ReactNode, type?: "default" | "red" }) => (
    <div className={`
    border-2 ${type === 'red' ? 'border-red-800/60 text-red-900' : 'border-slate-800/60 text-slate-800'} 
...
const V2PaperCard = ({ children, className = "", rotate = 0 }: { children: React.ReactNode, className?: string, rotate?: number }) => (
    <div
        className={`bg-[#fdfbf7] shadow-lg border border-gray-200 relative p-4 md:p-5 ${className} transition-transform hover:scale-[1.01] duration-300`}
        style={{
    ...
    return (
        <div className="w-full bg-[#f3f4f6] dark:bg-[#0a0a0a] min-h-screen py-8 px-2 md:px-4 font-[family-name:var(--font-kalam)] overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto mb-12 text-center relative z-10">
                ...
                <p className="text-slate-600 mt-2 font-bold">High-Density Revision Mode</p>
            </div>
            ...
            <div className="max-w-5xl mx-auto relative pl-6 md:pl-0 space-y-0 pb-20">
                ...
                <RowContainer className="mb-8 z-10">
                    <div className="relative">
                        <V2PaperCard rotate={-1} className="md:text-right md:mr-6">
                            ...
                            <ul className="text-sm text-slate-800 space-y-1 leading-tight">
                    ...
                    <div className="relative mt-2 md:mt-8">
                        <div className="bg-yellow-200 shadow-md p-4 transform rotate-2 md:ml-6 md:max-w-xs border-t-8 border-yellow-300/50 sticky-note relative">
                            <h4 className="font-bold text-xs uppercase text-slate-500 mb-1">Context</h4>
                            <p className="text-sm font-bold text-slate-900 leading-tight mb-2">Why? Control EIC corruption.</p>
                ...
                <RowContainer className="-mt-4 md:-mt-8 z-20">
                    <div className="relative order-2 md:order-1 mt-2 md:mt-10">
                        <div className="bg-white border-2 border-slate-300 border-dashed p-4 md:mr-6 transform -rotate-1 shadow-sm relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-2 opacity-5"><MapIcon size={64} /></div>
                            <h4 className="font-bold text-slate-500 text-xs uppercase mb-2">Concept: Separation</h4>
                            <div className="flex items-center gap-2 justify-center text-xs font-bold text-slate-800 border-b border-slate-200 pb-2 mb-2">
                            ...
                            <p className="text-xs text-center text-slate-600 italic">"Official Maps & Revenue = NO Court Link"</p>
                    ...
                    <div className="relative order-1 md:order-2">
                        <V2PaperCard rotate={1} className="md:ml-6 bg-[#fffdf0]">
                            ...
                            <div className="space-y-2 text-sm text-slate-800">
                                ...
                                <p className="border-t pt-1"><span className="font-bold text-slate-600 text-xs">Appeals go to:</span> GG-in-Council</p>
                            </div>
                ...
                <RowContainer className="-mt-4 md:-mt-6 z-10">
                    <div className="relative">
                        <V2PaperCard rotate={-2} className="md:mr-6">
                            <h3 className="text-xl font-bold text-blue-900 mb-3 border-b border-slate-200 pb-1">Pitt's India Act 1784</h3>
                            <div className="grid grid-cols-2 gap-2 text-center mb-3">
                                <div className="bg-amber-50 rounded p-2 border border-amber-100">
                                    ...
                                    <p className="text-[10px] text-slate-600">Commercial</p>
                                </div>
                                <div className="bg-blue-50 rounded p-2 border border-blue-100">
                                    <p className="font-bold text-[10px] uppercase text-blue-800">B.O.C.</p>
                                    <p className="text-[10px] text-slate-600">Political</p>
                                </div>
                            </div>
                            <p className="text-xs bg-slate-100 p-1 rounded text-center text-slate-700 font-bold">British Govt → Supreme Control</p>
                            <div className="hidden md:block"><Connector side="left" /></div>
                        </V2PaperCard>
                    </div>
                    <div className="relative mt-2 md:mt-12">
                        <div className="bg-white border text-center p-3 shadow-md transform rotate-3 md:ml-6 md:max-w-[200px] rounded-lg border-t-4 border-t-purple-400">
                            <Tag className="w-4 h-4 mx-auto text-purple-400 mb-1" />
                            <p className="text-[10px] uppercase font-bold text-slate-400">Name Change</p>
                            <p className="text-xs line-through text-slate-400">Company Territory</p>
                            <ArrowRight className="w-3 h-3 mx-auto text-slate-400 my-0.5" />
                ...
                <RowContainer className="mb-0 z-10 mt-8">
                    <V2PaperCard rotate={-1} className="bg-slate-50 border-slate-200">
                        <h3 className="text-lg font-bold text-slate-700 mb-2">Charter Act 1813</h3>
                ...
                <div className="max-w-2xl mx-auto mt-8 relative z-20">
                    <V2PaperCard rotate={0} className="border-t-4 border-t-slate-800">
                        <h3 className="text-xl font-bold text-slate-900 mb-2">Charter Act of 1853</h3>
                        <div className="grid md:grid-cols-2 gap-4 text-sm">
                            <div>
                                <p className="font-bold text-slate-800">Civil Services Open ✅</p>
                                <p className="text-xs text-slate-500 mb-2">Macaulay Committee</p>
                                <p className="font-bold text-slate-800">Mini-Parliament 🏛️</p>
                                <p className="text-xs text-slate-500">Leg/Exec Separated</p>
                            </div>
                            <div className="bg-slate-100 p-2 rounded text-center">
                                <p className="text-xs font-bold uppercase text-slate-400 mb-2">Local Rep (4/6)</p>
                                <div className="grid grid-cols-2 gap-1 text-[10px] font-bold text-slate-700">
