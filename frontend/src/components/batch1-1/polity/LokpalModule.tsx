        ...
        <ScrapbookContainer>
            ...
            <div className="relative bg-[#171717] border-4 border-slate-950 rounded-3xl p-8 md:p-12 shadow-[12px_12px_0px_0px_rgba(22,163,74,0.3)] overflow-hidden text-white">
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className="text-muted-foreground font-bold uppercase tracking-widest text-sm italic">The Ombudsman of India</span>
                    </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <LegalCard title="Lokpal Act (2013)" color="border-[#16a34a]">
                    ...
                    <div className="mt-4 p-4 bg-card border-2 border-slate-900 rounded-xl">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="p-3 bg-orange-50 border-l-4 border-[#ea580c] rounded">
                            ...
                            <div className="grid grid-cols-2 gap-2 text-[8px] font-black uppercase">
                                <div className="p-1 bg-card border rounded">50% Judicial</div>
                                <div className="p-1 bg-card border rounded text-orange-600">50% SC/ST/OBC/Women [PYQ]</div>
                            </div>
                        </div>
                        <div className="p-2 bg-muted border-2 border-dashed border-border rounded text-center">
            ...
            <div className="mt-8">
                <LegalCard title="The Selection Committee" color="border-slate-900" className="bg-muted">
                    <div className="flex flex-wrap gap-4 justify-center items-center py-4">
                        {[
                            ...
                            <div key={i} className="flex flex-col items-center p-3 bg-card border-2 border-slate-900 rounded-2xl shadow-sm min-w-[120px] text-center hover:scale-105 transition-transform rotate-1">
                                <UserCheck className="text-[#16a34a] mb-1" size={20} />
                                <p className="text-[10px] font-black uppercase">{p.label}</p>
                                <p className="text-[8px] font-bold italic text-muted-foreground">{p.sub}</p>
                            </div>
                        ))}
                    </div>
                </LegalCard>
                    ...
                    <div className="space-y-3">
                        ...
                        <ul className="grid grid-cols-1 gap-2">
                            {["Ministers & MPs", "Groups A, B, C, D Employees", "Foreign Contribution (>10L) Bodies"].map((item, i) => (
                                <li key={i} className="flex items-center gap-2 p-2 bg-muted rounded-lg border border-slate-100 text-[10px] font-black italic">
                    ...
                    <div className="space-y-4">
                        <div className="flex gap-4 p-4 bg-green-50 rounded-2xl border border-[#16a34a]">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-bold italic text-muted-foreground">Over CBI for cases referred by Lokpal.</p>
                            </div>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-3 bg-card border-2 border-slate-900 rounded-xl">
                                <SearchCheck className="text-muted-foreground mb-1" size={18} />
                                <p className="text-[10px] font-black uppercase">Search & Seizure</p>
                            </div>
                            <div className="p-3 bg-card border-2 border-slate-900 rounded-xl">
                                <Scale className="text-muted-foreground mb-1" size={18} />
            ...
            <div className="grid md:grid-cols-1 gap-8">
                <LegalCard title="Regional Variations" color="border-slate-900" className="bg-muted">
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="space-y-4">
                            <div className="p-5 bg-card border-2 border-[#16a34a] rounded-3xl relative shadow-md">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-4 p-4 bg-card border-2 border-slate-900 rounded-2xl rotate-1">
            ...
            <div className="mt-8 p-6 bg-[#ea580c]/5 border-4 border-dashed border-[#ea580c] rounded-3xl relative overflow-hidden">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <div className="p-4 bg-card border-2 border-[#ea580c] rounded-2xl shadow-sm">
            ...
            <div className="mt-16 text-center border-t-4 border-slate-900 pt-12 pb-12 font-['Kalam']">
                ...
                <p className="mt-4 text-muted-foreground font-black italic underline decoration-slate-200">The Power of Accountability.</p>
            </div>
        </ScrapbookContainer>
    );
}
