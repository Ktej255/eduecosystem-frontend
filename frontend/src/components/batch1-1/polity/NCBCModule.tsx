...
const ScrapbookContainer = ({ children }: { children: React.ReactNode }) => (
    <div className="bg-[#fff7ed] min-h-screen p-4 md:p-8 font-['Kalam'] selection:bg-orange-100">
        <div className="max-w-6xl mx-auto space-y-12 bg-[url('https://www.transparenttextures.com/patterns/crumpled-paper.png')] bg-card/80 rounded-3xl p-6 shadow-2xl border-2 border-orange-200 relative overflow-hidden">
...
const JusticeCard = ({ title, children, color = "border-orange-600", className = "" }: { title: string, children: React.ReactNode, color?: string, className?: string }) => (
    <div className={`bg-card border-2 ${color} rounded-2xl p-6 shadow-[6px_6px_0px_0px_rgba(234,88,12,0.1)] relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 ${className}`}>
        ...
        <ScrapbookContainer>
                ...
                <JusticeCard title="The Timeline [High Yield]" color="border-[#4b5563]">
                    <div className="space-y-6 relative pl-6 before:absolute before:left-0 before:top-2 before:bottom-2 before:w-0.5 before:bg-slate-200">
                        <div className="relative">
                            ...
                            <h4 className="font-black text-muted-foreground">1992 - Mandal Case [PYQ]</h4>
                            <p className="text-xs font-bold text-muted-foreground italic leading-relaxed">Supreme Court directed Govt to create a permanent body for BCs.</p>
                        </div>
                        <div className="relative p-3 bg-muted border-2 border-border rounded-xl transform rotate-1">
                            ...
                            <p className="text-[10px] font-bold text-muted-foreground">Established under NCBC Act, 1993. (Wooden Post Era)</p>
                        </div>
                ...
                <JusticeCard title="Composition (The Standard)" color="border-[#ea580c]">
                    <div className="bg-orange-50/50 p-6 rounded-2xl border-4 border-dotted border-orange-200">
                        <div className="grid grid-cols-2 gap-4 mb-6">
                            <div className="col-span-2 text-center p-4 bg-card border-2 border-[#ea580c] rounded-2xl shadow-sm relative overflow-hidden">
                            ...
                            <div className="text-center p-3 bg-card border-2 border-orange-200 rounded-xl shadow-sm">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-3 p-3 bg-card rounded-xl border border-orange-100 italic font-bold">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-3">
                        {[
                            ...
                            <div key={idx} className="flex gap-4 p-3 bg-orange-50/50 rounded-xl border border-orange-100 group">
                                <div className="p-2 bg-card rounded-lg shadow-sm group-hover:bg-[#ea580c] group-hover:text-white transition-colors">
                                    <item.icon size={18} />
                                </div>
                ...
                <JusticeCard title="Powers & Consultation" color="border-[#ca8a04]">
                    <div className="space-y-4">
                        <div className="p-5 bg-card border-b-4 border-r-4 border-slate-900 rounded-2xl">
                            <h4 className="flex items-center gap-2 font-black text-foreground mb-3 underline decoration-wavy decoration-[#ea580c]">
                        ...
                        <div className="p-5 bg-orange-900 text-white rounded-2xl relative overflow-hidden group">
                            <div className="absolute top-0 right-0 w-16 h-16 bg-card/10 -mr-8 -mt-8 rounded-full"></div>
            ...
            <div className="grid md:grid-cols-1 gap-8">
                <JusticeCard title="Who Decides the List? [CRITICAL UPDATE]" color="border-[#ea580c]" className="bg-[#fff7ed]">
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="p-6 bg-card border-2 border-[#ca8a04] rounded-3xl relative">
                            <h5 className="font-black text-[#ca8a04] flex items-center gap-2 mb-4">
                                <ListChecks /> Central List
                            </h5>
                            <p className="text-xs font-black text-muted-foreground leading-relaxed italic">
            ...
            <div className="bg-[#4b5563] text-white border-4 border-slate-900 rounded-3xl p-8 relative overflow-hidden shadow-2xl">
                ...
                <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
                    <div className="w-24 h-24 bg-card border-4 border-[#ea580c] rounded-full flex flex-col items-center justify-center text-[#ea580c] shrink-0 transform rotate-6 shadow-xl">
                        <GitBranch size={40} />
            ...
            <div className="mt-16 text-center border-t-2 border-dashed border-border pt-12 pb-12">
                ...
                <p className="mt-4 text-muted-foreground font-bold italic">The Shield of Article 338-B.</p>
            </div>
        </ScrapbookContainer>
    );
}
