...
import {
    ...
    Users, Briefcase, UserPlus, Balance,
        ...
        <ScrapbookContainer>
            ...
            <div className="relative bg-[#18181b] border-4 border-slate-950 rounded-3xl p-8 md:p-12 shadow-[12px_12px_0px_0px_rgba(0,0,0,0.3)] overflow-hidden text-white">
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-4">
                        <Badge className="bg-[#854d0e] text-white px-4 py-1 text-lg border-2 border-white shadow-md">Chapter 48</Badge>
                        <div className="h-[2px] w-12 bg-white/30"></div>
                        <span className="text-slate-400 font-bold uppercase tracking-widest text-sm italic">The Highest Law Officer</span>
                    </div>
                ...
                <LegalCard title="Article 76 (The Source)" color="border-[#854d0e]">
                    <div className="space-y-4">
                        <div className="p-4 bg-yellow-50 border-2 border-[#854d0e] rounded-xl transform rotate-1">
                            ...
                            <p className="text-lg font-black text-slate-900 underline decoration-slate-300 underline-offset-4">THE PRESIDENT</p>
                        </div>
                        <div className="p-4 bg-white border-2 border-slate-900 rounded-xl relative">
                            <h4 className="font-black text-slate-900 mb-2 italic">Qualification: [PYQ]</h4>
                            ...
                            <div className="mt-3 grid grid-cols-2 gap-2">
                                <div className="p-2 bg-slate-50 border rounded text-[8px] font-black uppercase tracking-tighter">5y HC Judge</div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <LegalCard title="Privileges & Rights" color="border-slate-900">
                    <div className="space-y-3">
                        {[
                            ...
                            <div key={i} className="flex gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-100 group hover:bg-black hover:text-white transition-all">
                                <div className="p-2 bg-white rounded-xl shadow-sm group-hover:bg-[#854d0e] transition-colors">
                                    <item.icon size={20} className="text-slate-900 group-hover:text-white" />
                                </div>
                ...
                <LegalCard title="Duties (The Advocate)" color="border-[#854d0e]">
                    <div className="space-y-4">
                        <div className="p-4 bg-white border-2 border-slate-900 rounded-xl shadow-md">
                            <h4 className="flex items-center gap-2 font-black text-slate-900 mb-3 underline decoration-[#854d0e]">
            ...
            <div className="grid md:grid-cols-1 gap-8">
                <LegalCard title="Limitations & Solicitor General" color="border-slate-900" className="bg-slate-50">
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="space-y-4">
                            <h5 className="font-black text-red-600 uppercase text-xs flex items-center gap-2">
                                <ShieldAlert size={16} /> Limitations [PYQ]
                            </h5>
                            <ul className="space-y-2 text-[11px] font-bold italic text-slate-600">
                                ...
                                <li className="flex gap-2 text-slate-900"><span>-</span> <span className="font-black">Note:</span> Not a Government Servant. Can do private practice.</li>
                            </ul>
                        </div>
                        <div className="p-6 bg-white border-2 border-slate-900 rounded-3xl relative">
                            ...
                            <div className="flex gap-4">
                                ...
                                <ArrowBigUpDash className="rotate-270 text-slate-400" />
                                <Badge className="bg-slate-200 text-slate-600">SG</Badge>
                            </div>
                        </div>
                    </div>
                </LegalCard>
            ...
            <div className="mt-16 text-center border-t-4 border-slate-900 pt-12 pb-12 font-['Kalam']">
                ...
                <p className="mt-4 text-slate-400 font-black italic">Article 76: The Silk Robe of the Union.</p>
            </div>
        </ScrapbookContainer>
    );
}
