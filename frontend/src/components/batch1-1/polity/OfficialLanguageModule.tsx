...
const ScrapbookContainer = ({ children }: { children: React.ReactNode }) => (
    <div className="bg-[#fff4f4] min-h-screen p-4 md:p-8 font-['Kalam'] selection:bg-rose-100 selection:text-rose-950">
        <div className="max-w-5xl mx-auto space-y-12 bg-white rounded-3xl p-6 shadow-2xl border-4 border-rose-900 relative overflow-hidden bg-[url('https://www.transparenttextures.com/patterns/natural-paper.png')]">
...
const ScriptCard = ({ title, children, color = "border-rose-900", className = "" }: { title: string, children: React.ReactNode, color?: string, className?: string }) => (
    <div className={`bg-white border-2 ${color} rounded-2xl p-6 shadow-[4px_4px_0px_0px_rgba(225,29,72,0.1)] relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 ${className}`}>
    ...
    return (
        <ScrapbookContainer>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <ScriptCard title="The Constitutional Choice" color="border-[#e11d48]">
                    <div className="p-5 bg-rose-50 border-x-4 border-rose-600 rounded-3xl relative overflow-hidden group">
                        ...
                        <div className="p-3 bg-white border-2 border-rose-200 rounded-xl">
                            <p className="text-[10px] font-black uppercase text-slate-400">Numerals:</p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <ScriptCard title="Regional Languages" color="border-[#fbbf24]">
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-200 relative">
                    ...
                    <div className="p-5 bg-rose-900 text-white rounded-3xl relative overflow-hidden group">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="p-3 bg-slate-950/50 rounded-xl">
                                <p className="text-[8px] font-black uppercase text-slate-400">Governor's Power:</p>
            ...
            <div className="grid md:grid-cols-1 gap-8">
                <ScriptCard title="Constitutional Safeguards" color="border-slate-900" className="bg-slate-50">
                    <div className="grid md:grid-cols-3 gap-6">
                        <div className="p-5 bg-white border-2 border-rose-600 rounded-[2rem] shadow-sm transform -rotate-1 relative overflow-hidden">
                            ...
                            <p className="text-[10px] font-black uppercase text-slate-400">Art 350:</p>
                        ...
                        <div className="p-5 bg-white border-2 border-rose-600 rounded-[2rem] shadow-sm transform rotate-1">
                            <Book size={24} className="text-rose-600 mb-2" />
                            <p className="text-[10px] font-black uppercase text-slate-400">Art 350-A:</p>
                        ...
                        <div className="p-5 bg-white border-2 border-rose-600 rounded-[2rem] shadow-sm transform -rotate-2 relative">
                            <div className="absolute -top-2 -right-2 border-2 border-rose-600 rounded-full bg-white p-1"><UserCheck size={16} className="text-rose-600" /></div>
                            <p className="text-[10px] font-black uppercase text-slate-400">Art 350-B:</p>
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-center">
                            {[
                                ...
                                <div key={i} className="p-2 border border-white/10 rounded-xl bg-white/5 hover:bg-rose-600 transition-colors">
            ...
            <div className="mt-16 text-center border-t-4 border-rose-900 pt-12 pb-12 font-['Kalam']">
                ...
                <p className="mt-4 text-slate-400 font-bold italic tracking-widest text-center">Art 351: Developing Hindi as a Medium of Expression.</p>
            </div>
        </ScrapbookContainer>
    );
}
