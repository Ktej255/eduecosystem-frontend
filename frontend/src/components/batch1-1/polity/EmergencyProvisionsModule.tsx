...
const NotebookContainer = ({ children }: { children: React.ReactNode }) => (
    <div className="min-h-screen p-4 md:p-8 font-sans relative overflow-hidden bg-[#f0f0f0] text-slate-800">
...
const SketchyBox = ({ children, color = "red", className = "" }: { children: React.ReactNode, color?: "red" | "orange" | "green" | "slate", className?: string }) => {
    const borders = {
        ...
        slate: "border-slate-600 bg-white",
    };
    ...
    return (
        <NotebookContainer>
            ...
            <div className="text-center relative py-10">
                ...
                <div className="inline-block border-4 border-red-600 p-4 bg-white shadow-[8px_8px_0px_rgba(220,38,38,0.8)] rotate-[-1deg]" style={{ borderRadius: "2px 20px 5px 15px" }}>
                    ...
                    <h1 className="text-5xl md:text-7xl font-black text-slate-900 mb-2" style={{ fontFamily: 'Kalam, cursive' }}>
                        THE RED ALERT
                    </h1>
                    <h2 className="text-2xl font-bold text-red-600 font-serif">Emergency Provisions</h2>
                </div>
                <p className="mt-6 text-xl text-slate-600 font-handwriting italic max-w-2xl mx-auto bg-yellow-100/80 p-2 rounded transform rotate-[1deg]">
            ...
            <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <ul className="space-y-4 font-handwriting text-lg">
                            ...
                            <li className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="bg-yellow-100 p-2 text-sm mt-1 border border-yellow-300 text-slate-700 rotate-1">
                    ...
                    <SketchyBox color="slate" className="bg-white">
                        ...
                        <div className="space-y-0 relative">
                            {/* Vertical Line */}
                            <div className="absolute left-4 top-2 bottom-2 w-0.5 bg-slate-300 border-l-2 border-dashed border-slate-300"></div>

                            {/* Steps */}
                            <div className="relative pl-10 pb-6">
                                <div className="absolute left-0 top-0 w-8 h-8 bg-white border-2 border-slate-700 rounded-full flex items-center justify-center font-bold text-sm">1</div>
                            ...
                            <div className="relative pl-10 pb-6">
                                ...
                                <p className="text-sm text-slate-500">(Originally 2 months. Reduced by 44th AA).</p>
                            </div>

                            <div className="relative pl-10 pb-6">
                                <div className="absolute left-0 top-0 w-8 h-8 bg-white border-2 border-slate-700 rounded-full flex items-center justify-center font-bold text-sm">3</div>
                                <h4 className="font-bold text-lg">Special Majority</h4>
                                <p className="text-sm text-slate-500">Total Membership + 2/3rd Present & Voting.</p>
                            </div>
                            ...
                            <div className="relative pl-10">
                                ...
                                <p className="text-sm text-slate-500">Can extend indefinitely (Approval every 6 months).</p>
                            </div>
                        </div>
                    </SketchyBox>
                </div>
                ...
                <div className="flex justify-center">
                    <SketchyBox color="slate" className="max-w-md w-full text-center bg-gray-50">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-left text-sm">
                            <div className="bg-white p-2 border border-slate-300 shadow-sm rotate-[-1deg]">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <SketchyBox color="orange">
                        ...
                        <div className="space-y-4">
                            <div className="p-3 bg-white border-l-4 border-orange-500 shadow-sm">
                                <strong className="text-orange-700 block">Article 356</strong>
                                <span className="text-slate-600">"Failure of Constitutional Machinery". Governor's report or otherwise.</span>
                            </div>

                            <div className="p-3 bg-white border-l-4 border-red-500 shadow-sm">
                                ...
                                <span className="text-slate-600">State fails to comply with Centre's Directions.</span>
                            </div>
                        </div>
                    </SketchyBox>
                    ...
                    <SketchyBox color="slate" className="bg-orange-50/50">
                        ...
                        <div className="space-y-3 font-handwriting text-lg">
                            <div className="flex justify-between items-center border-b border-orange-200 pb-2">
                                <span className="text-slate-600">Time to Approve</span>
                                <span className="font-bold text-orange-700">2 Months</span>
                            </div>
                            <div className="flex justify-between items-center border-b border-orange-200 pb-2">
                                <span className="text-slate-600">Majority</span>
            ...
            <div className="space-y-6 pt-8">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <SketchyBox color="green">
                        ...
                        <p className="text-slate-600 mb-4">Ground: Threat to Financial Stability or Credit of India.</p>

                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-white p-3 rounded border border-emerald-200 text-center">
                                <span className="block text-xs text-slate-400 uppercase font-bold">Approval</span>
            ...
            <div className="pt-12 pb-8">
                ...
                >
                    <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-center">
                        <div className="bg-yellow-400 text-slate-900 px-6 py-2 font-black font-serif text-xl shadow-lg border-2 border-slate-900 -rotate-2">
                            44th AMENDMENT (1978)
                        </div>
                        <div className="text-xs text-slate-400 font-mono mt-1 bg-slate-900 px-2 rounded">THE ANTI-ABUSE SHIELD</div>
                    </div>
