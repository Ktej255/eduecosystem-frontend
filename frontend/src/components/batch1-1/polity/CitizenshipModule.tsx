    ...
    return (
        <ImmigrationContainer>
            ...
            <Tabs defaultValue="constitutional" className="w-full">
                <TabsList className="grid w-full grid-cols-4 bg-white p-1 rounded-lg shadow-sm border h-auto">
                    <TabsTrigger value="constitutional" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-700 py-3 text-xs md:text-sm font-bold">1950 Status</TabsTrigger>
                    <TabsTrigger value="acquisition" className="data-[state=active]:bg-green-50 data-[state=active]:text-green-700 py-3 text-xs md:text-sm font-bold">Acquisition</TabsTrigger>
                    <TabsTrigger value="loss" className="data-[state=active]:bg-red-50 data-[state=active]:text-red-700 py-3 text-xs md:text-sm font-bold">Loss & OCI</TabsTrigger>
                    <TabsTrigger value="caa" className="data-[state=active]:bg-orange-50 data-[state=active]:text-orange-700 py-3 text-xs md:text-sm font-bold">CAA 2019</TabsTrigger>
                </TabsList>

                {/* PHASE 1: CONSTITUTIONAL STATUS */}
                <TabsContent value="constitutional" className="mt-6 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                {/* PHASE 2: ACQUISITION */}
                <TabsContent value="acquisition" className="mt-6 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    <div className="grid md:grid-cols-2 gap-6">
                ...
                {/* PHASE 3: LOSS & OCI */}
                <TabsContent value="loss" className="mt-6 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    <div className="grid md:grid-cols-2 gap-6">
                ...
                {/* PHASE 4: CAA 2019 */}
                <TabsContent value="caa" className="mt-6 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
