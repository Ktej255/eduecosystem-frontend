...
const ScrapbookContainer = ({ children }: { children: React.ReactNode }) => (
    <div className="bg-[#fcfaf2] min-h-screen p-4 md:p-8 font-['Kalam'] selection:bg-green-100">
        <div className="max-w-6xl mx-auto space-y-12 bg-[url('https://www.transparenttextures.com/patterns/crumpled-paper.png')] bg-card/70 rounded-3xl p-6 shadow-xl border-2 border-border relative overflow-hidden">
            {/* Tribal Motif Decor */}
        ...
        <ScrapbookContainer>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <TribalCard title="The 89th Amendment (2003)" color="border-[#92400e]">
                    <div className="space-y-4">
                        <div className="p-4 bg-green-50 border-2 border-dashed border-[#16a34a] rounded-xl transform rotate-1">
                            ...
                            <p className="text-sm font-bold text-muted-foreground mt-2 leading-relaxed italic">
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex items-center gap-4 bg-card p-3 border-2 border-slate-100 rounded-xl relative overflow-hidden">
                                <div className="absolute top-0 left-0 w-1 h-full bg-slate-300"></div>
                                <span className="font-black text-muted-foreground">Old: Art 338</span>
                                <span className="text-xs font-bold text-muted-foreground">NCSC</span>
                            </div>
                            <div className="flex items-center gap-4 bg-card p-3 border-2 border-[#16a34a] rounded-xl relative overflow-hidden shadow-sm">
                ...
                <TribalCard title="Composition (The Council)" color="border-[#16a34a]">
                    <div className="bg-muted p-6 rounded-2xl border-4 border-dotted border-border">
                        <div className="flex flex-wrap gap-4 justify-center mb-6">
                            <div className="text-center p-3 bg-card border-2 border-[#16a34a] rounded-xl shadow-sm min-w-[100px]">
                            ...
                            <div className="text-center p-3 bg-card border-2 border-[#92400e] rounded-xl shadow-sm min-w-[100px]">
                            ...
                            <div className="text-center p-3 bg-card border-2 border-green-200 rounded-xl shadow-sm min-w-[100px]">
                                <Users className="mx-auto text-green-400" size={24} />
                                <p className="text-[10px] font-black mt-1">3 Members</p>
                            </div>
                        </div>
                        <div className="space-y-3">
                            <div className="p-3 bg-card rounded-xl border-t-4 border-[#b91c1c] shadow-sm">
                                <h4 className="text-[10px] font-black text-[#b91c1c] uppercase">Critical Condition:</h4>
                                <p className="text-xs font-black italic mt-1 text-muted-foreground">At least <span className="underline decoration-[#b91c1c]">one member</span> must be a woman. [PYQ]</p>
                            </div>
                    ...
                    <div className="space-y-3 relative p-4 bg-green-50/50 rounded-2xl border-2 border-dashed border-green-200">
                        ...
                        {[
                            ...
                            <div key={idx} className="flex gap-4 items-start group">
                                <div className="p-1.5 bg-card border border-green-200 rounded text-[10px] font-black group-hover:bg-green-600 group-hover:text-white transition-colors">{idx + 1}</div>
                ...
                <TribalCard title="Special Mandate (2005 Notification) [CRITICAL]" color="border-[#16a34a]">
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-card border-2 border-dashed border-border rounded flex items-center justify-center italic text-muted-foreground text-xs text-center font-bold">
            ...
            <div className="bg-[#92400e] text-white border-4 border-orange-950 rounded-3xl p-8 relative overflow-hidden shadow-2xl">
                <div className="absolute top-0 right-0 w-48 h-48 bg-card/5 -mr-24 -mt-24 rounded-full blur-2xl"></div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10 font-bold">
                    <div className="flex flex-col items-center gap-2">
                        <div className="p-4 bg-card rounded shadow-xl text-[#92400e] border-2 border-[#16a34a]">
                            <FileText size={32} />
                        </div>
                        <span className="text-[10px] uppercase">NCST</span>
                    </div>

                    <div className="hidden md:block w-8 h-[2px] bg-card opacity-50"></div>
                    ...
                    <div className="flex-1 grid grid-cols-2 gap-4 w-full md:w-auto">
                        <div className="p-3 bg-card/10 border border-white/20 rounded-xl text-center backdrop-blur-sm">
            ...
            <div className="mt-16 text-center border-t-2 border-dashed border-border pt-12 pb-12">
                ...
                <p className="mt-4 text-muted-foreground font-bold">The Shield of Article 338-A.</p>
            </div>
        </ScrapbookContainer>
    );
}
