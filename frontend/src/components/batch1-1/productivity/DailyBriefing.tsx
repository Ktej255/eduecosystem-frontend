...
export default function DailyBriefing() {
    ...
    const loadQuiz = async () => {
        ...
        try {
            ...
            const response = await fetch(`${(process.env.NEXT_PUBLIC_API_URL || "https://eduecosystem-backend-503001969959.us-central1.run.app").replace(/\/$/, "")}/api/v1/productivity/news-quiz`, {
                method: 'POST',
                headers: {
