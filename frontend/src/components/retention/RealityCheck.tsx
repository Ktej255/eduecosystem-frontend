...
export default function RealityCheck({
    ...
    return (
        <motion.div
            ...
            className="p-6 rounded-2xl bg-card/80 backdrop-blur-xl border border-border transition-colors"
        >
            {/* Header */}
            ...
            <div className="flex items-center gap-6">
                <ChartErrorBoundary name="Retention Pulse">
                ...
                <div className="flex-1 space-y-3">
                    <div>
                        ...
                        <p className="text-foreground font-medium">{topicName}</p>
                    </div>
