...
export default function StandardMCQInterface({
    ...
    return (
        <div className="animate-in fade-in duration-300 min-h-screen bg-slate-50 dark:bg-black p-4 md:p-6 pb-24 md:pb-6 relative">
            <Card className="max-w-6xl mx-auto bg-white dark:bg-gray-950 border-gray-200 dark:border-gray-800 shadow-xl overflow-hidden flex flex-col md:flex-row min-h-[600px]">
                ...
                <div className={`
                    fixed inset-0 z-50 bg-white dark:bg-gray-950 md:static md:w-80 md:border-l border-gray-200 dark:border-gray-800 flex flex-col transition-transform duration-300
                    ${isPaletteOpen ? 'translate-x-0' : 'translate-x-full md:translate-x-0'}
                `}>
                    <div className="p-4 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center bg-slate-50 dark:bg-slate-900/50">
                        <h3 className="font-bold text-slate-700 dark:text-slate-200">Question Map</h3>
                    ...
                    <div className="p-4 border-t border-gray-200 dark:border-gray-800 text-xs text-slate-500 space-y-2 bg-slate-50 dark:bg-slate-900/50">
