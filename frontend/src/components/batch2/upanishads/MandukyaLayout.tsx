    ...
    return (
        <div className="space-y-16">
            <div className="text-center max-w-4xl mx-auto space-y-6">
                <h2 className="text-5xl md:text-7xl font-serif font-bold text-[var(--sp-text-hi)] italic tracking-tighter">
                    {lang === "en" ? "The Shortest Bridge to Infinity" : "अनंतता का लघुतम सेतु"}
                </h2>
                <p className="text-[var(--sp-text-lo)] leading-relaxed text-xl font-light max-w-2xl mx-auto">
                    {lang === "en"
                ...
                <div className="flex justify-center pt-8">
                    <div className="relative group">
                        <div className="absolute -inset-4 bg-indigo-500/20 rounded-full blur-2xl group-hover:bg-[#1a1a33] transition-all duration-500 animate-pulse" />
                        <div className="relative text-9xl font-serif text-[var(--sp-text-hi)] drop-shadow-[0_0_50px_rgba(129,140,248,0.5)]">ॐ</div>
                    </div>
                </div>
            </div>

            <div className="bg-[var(--sp-surface)]/50 rounded-[3rem] p-12 border border-[var(--sp-border)] backdrop-blur-md relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[var(--sp-surface)] to-transparent opacity-30" />
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {states.map((s, i) => (
                        <motion.div
                            ...
                            className="group cursor-pointer space-y-4 text-center p-6 rounded-3xl hover:bg-[#1a1a33] transition-all border border-transparent hover:border-[var(--sp-border)]"
                        >
                            ...
                            <div>
                                ...
                                <p className="text-[var(--sp-text-lo)] text-[10px] font-black uppercase tracking-[0.2em] mb-3">Vibration: {s.sound}</p>
        ...
        <div className="space-y-12">
            <div className="text-center space-y-4">
                ...
                <div className="flex items-center justify-center gap-4">
                    ...
                    <p className="text-[var(--sp-text-lo)] font-black tracking-[0.3em] uppercase text-[10px]">{subtitle}</p>
                    <div className="h-px w-12 bg-indigo-500/30" />
                </div>
            </div>
            ...
            >
                <div className="bg-[var(--sp-surface)] border border-[var(--sp-border)] rounded-[3rem] overflow-hidden shadow-[0_0_100px_rgba(99,102,241,0.1)] backdrop-blur-xl">
                    <div className="p-8 md:p-16 space-y-12">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-[var(--sp-text-lo)] text-[10px] font-black uppercase tracking-[0.2em] mt-1">Sutra Analysis</p>
                                </div>
                            </div>
                            <div className="hidden sm:flex items-center gap-3 px-4 py-2 bg-indigo-500/10 rounded-full border border-[var(--sp-border)]">
                                <div className="w-2 h-2 rounded-full bg-indigo-400 animate-pulse" />
                                <span className="text-[var(--sp-text-lo)] text-[10px] font-black tracking-widest uppercase">Direct Transmission</span>
                            </div>
                        </div>

                        {/* Sanskrit Core */}
                        <div className="relative group">
                            <div className="absolute -inset-4 bg-gradient-to-r from-[var(--sp-gold)]/5 via-[var(--sp-surface)]0/5 to-[var(--sp-bg)]/5 rounded-[2rem] opacity-0 group-hover:opacity-100 transition-opacity" />
                            <div className="relative bg-[var(--sp-surface)]/80 rounded-[2.5rem] p-12 border border-[var(--sp-border)] shadow-inner text-center">
                                <p className="text-3xl md:text-4xl text-[var(--sp-text-hi)] leading-[1.6] font-serif italic" style={{ fontFamily: "'Noto Serif Devanagari', serif" }}>
                                    {shloka.sanskrit}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-6">
                                <div className="p-8 bg-[var(--sp-surface)] rounded-3xl border border-[var(--sp-border)] relative group">
                                    <Languages className="absolute top-6 right-6 w-5 h-5 text-[var(--sp-text-hi)]0/30 group-hover:text-[var(--sp-text-lo)] transition-colors" />
                                    <h4 className="text-[var(--sp-text-lo)] text-[10px] font-black uppercase tracking-widest mb-4">Translation</h4>
                                ...
                                {shloka.wordMeanings && shloka.wordMeanings.length > 0 && (
                                    <div className="p-8 bg-[var(--sp-surface)]/40 rounded-3xl border border-white/5">
                                        <h4 className="text-[var(--sp-gold)] text-[10px] font-black uppercase tracking-widest mb-6 flex items-center gap-2">
                                            ...
                                            {shloka.wordMeanings.map((m: any, i: number) => (
                                                <div key={i} className="flex items-center justify-between group/word">
                                                    <div className="flex items-center gap-3">
                                                        <span className="text-[var(--sp-text-hi)] font-serif text-lg group-hover/word:text-[var(--sp-text-lo)] transition-colors">{m.devanagari}</span>
                                                        <span className="h-px w-4 bg-indigo-500/10" />
                                                    </div>
                                                    <span className="text-[var(--sp-text-lo)] text-sm font-light italic">{lang === "en" ? m.english : m.hindi}</span>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                            ...
                            <div className="space-y-6">
                                <div className="p-10 bg-gradient-to-br from-[var(--sp-gold)]/20 to-[var(--sp-bg)]/20 rounded-[2.5rem] border border-[var(--sp-border)] shadow-2xl relative overflow-hidden h-full">
                                    ...
                                    <p className="text-[var(--sp-text-hi)] text-2xl leading-relaxed font-serif italic text-center py-4">
                                        {lang === "en" ? shloka.simpleExplanation : shloka.simpleExplanationHindi}
                                    </p>
                                    <div className="mt-8 pt-8 border-t border-[var(--sp-border)] flex flex-col gap-4">
                                        <button
                                            onClick={() => (window as any).showSadhanaTimer && (window as any).showSadhanaTimer()}
                                            className="w-full bg-white text-indigo-900 hover:bg-[#1a1a33] font-black p-4 rounded-2xl flex items-center justify-center gap-3 transition-all shadow-xl hover:scale-[1.02] active:scale-95"
                                        >
                                            <Flame className="w-5 h-5" /> START CONTEMPLATION
                                        </button>
                                        <button
                                            onClick={() => (window as any).showExperienceReport && (window as any).showExperienceReport()}
                                            className="w-full bg-[var(--sp-surface)] text-[var(--sp-text-hi)] border border-[var(--sp-border)] hover:bg-slate-800 font-bold p-4 rounded-2xl flex items-center justify-center gap-3 transition-all"
                                        >
            ...
            <div className="max-w-4xl mx-auto flex items-center justify-center gap-8">
                <button
                    ...
                    className="w-16 h-16 flex items-center justify-center bg-[var(--sp-surface)] text-[var(--sp-text-lo)] rounded-full border border-[var(--sp-border)] hover:bg-[#1a1a33] hover:text-white transition-all disabled:opacity-20 shadow-xl"
                >
                    <ChevronLeft className="w-8 h-8" />
                </button>

                <div className="flex bg-[var(--sp-surface)]/80 p-3 rounded-full border border-[var(--sp-border)] gap-3 overflow-x-auto no-scrollbar">
                    {data.map((_, i) => (
                        <button
                            key={i}
                            onClick={() => setCurrentIndex(i)}
                            className={`w-12 h-12 rounded-full text-sm font-black transition-all ${i === currentIndex ? 'bg-indigo-500 text-white shadow-lg scale-110' : 'text-[var(--sp-text-hi)]0/40 hover:text-[var(--sp-text-lo)]'}`}
                        >
                            {i + 1}
                        </button>
                    ))}
    ...
    if (mode === 'immersive') {
        return (
            <div className="relative w-full min-h-screen bg-[var(--sp-bg)]">
                ...
                <MandukyaImmersiveExperience lang={lang} onClose={() => setMode('classic')} />
            </div>
        );
    }

    return (
        <div className="min-h-screen bg-[var(--sp-surface)] text-[var(--sp-text-hi)] selection:bg-indigo-500/30">
            ...
            <header className="relative h-[65vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-6 max-w-5xl">
                    <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        <span className="inline-block px-8 py-2.5 bg-indigo-500/10 text-[var(--sp-text-lo)] rounded-full text-[10px] font-black tracking-[0.6em] uppercase border border-[var(--sp-border)] backdrop-blur-md mb-12">
                            Atharva Veda • The Science of Sound & Self
                        </span>
                        <h1 className="text-7xl md:text-[11rem] font-serif font-black text-transparent bg-clip-text bg-gradient-to-b from-[var(--sp-gold)] via-[var(--sp-surface)] to-[var(--sp-bg)] leading-none tracking-tighter mb-8 shadow-2xl">
                            Mandukya
                        </h1>
                        <div className="flex flex-col md:flex-row items-center justify-center gap-6 mt-12 text-2xl md:text-3xl font-light text-[var(--sp-text-lo)] animate-pulse">
            ...
            <nav className="sticky top-0 z-50 bg-[var(--sp-surface)]/90 backdrop-blur-3xl border-b border-[var(--sp-border)] px-6 py-5">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-6">
                        <button onClick={() => router.push("/student/batch2/upanishads")} className="p-3 bg-indigo-500/10 text-[var(--sp-text-lo)] hover:bg-[#1a1a33] hover:text-white rounded-2xl transition-all border border-[var(--sp-border)]">
                            <ArrowLeft className="w-5 h-5" />
                        </button>
                        <div className="hidden sm:block">
                            <h2 className="text-xl font-black text-white leading-tight font-serif tracking-tight">Mandukya</h2>
                            <p className="text-[var(--sp-gold)]/60 text-[10px] font-black uppercase tracking-widest">{lang === "en" ? "AUM Analysis" : "ओङ्कार विवेचन"}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex bg-[var(--sp-surface)]/80 rounded-[1.5rem] p-1.5 border border-white/5 shadow-2xl overflow-x-auto no-scrollbar max-w-[60%] md:max-w-none">
                        {tabs.map((tab) => (
                            <button
                                ...
                                className={`flex items-center gap-2 px-6 py-3 rounded-2xl text-xs font-black transition-all ${activeTab === tab.id ? "bg-indigo-50 text-indigo-900 shadow-xl scale-105" : "text-[var(--sp-gold)] hover:text-[var(--sp-text-lo)]"}`}
                            >
                        ...
                        <div className="flex bg-[var(--sp-surface)]/80 rounded-xl p-1 border border-white/5">
                            {(["en", "hi"] as const).map((l) => (
                                <button
                                    key={l}
                                    onClick={() => setLang(l)}
                                    className={`px-4 py-1.5 rounded-lg text-[10px] font-black transition-all ${lang === l ? "bg-indigo-500 text-white" : "text-[var(--sp-gold)] hover:text-[var(--sp-text-lo)]"}`}
                                >
                                    {l.toUpperCase()}
                                </button>
                            ))}
            ...
            <footer className="bg-[var(--sp-surface)] py-48 text-center border-t border-[var(--sp-border)] relative overflow-hidden">
                <div className="relative z-10 space-y-12">
                    <div className="text-8xl md:text-[10rem] font-serif text-[var(--sp-text-hi)]0/20 animate-pulse">ॐ</div>
                    <div className="space-y-4">
                        <p className="text-5xl md:text-7xl font-serif text-[var(--sp-text-hi)] leading-tight">शान्तं शिवमद्वैतम्</p>
                    ...
                    <p className="text-[var(--sp-text-hi)]0/40 text-[10px] font-black uppercase tracking-[0.5em] mt-20">— Mandukya Upanishad —</p>
                </div>
