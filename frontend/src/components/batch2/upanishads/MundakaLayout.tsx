            ...
            >
                ...
                <div className="grid grid-cols-2 gap-4 mt-6">
                    ...
                    <button
                        ...
                        className="bg-teal-600/20 hover:bg-teal-600/30 border border-teal-500/30 rounded-xl p-4 text-teal-300 font-bold text-sm flex items-center justify-center gap-2 transition-all"
                    >
                ...
                <AnimatePresence>
                    {reportActive && (
                        <ExperienceReport
                            ...
                            title="Mundaka Upanishad: Internal Shift"
                        />
                    )}
                </AnimatePresence>
            </footer>
