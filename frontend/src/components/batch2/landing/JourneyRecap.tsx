        ...
        <div className="w-full py-12 px-4" id="journey-recap">
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-slate-400">Your path through the wisdom texts</p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-10">
                    <div className="bg-slate-900/50 border border-white/5 rounded-xl p-6 text-center">
                        ...
                        <div className="text-xs text-slate-400 uppercase tracking-widest">Sessions</div>
                    </div>
                    <div className="bg-slate-900/50 border border-white/5 rounded-xl p-6 text-center">
                    ...
                    <div className="bg-slate-900/50 border border-white/5 rounded-xl p-6 text-center col-span-2 md:col-span-1">
                        ...
                        <div className="text-xs text-slate-400 uppercase tracking-widest">Texts Explored</div>
                    </div>
                </div>
                ...
                {sessions.length === 0 ? (
                    <div className="text-center py-16 bg-slate-900/30 rounded-2xl border border-white/5">
                        ...
                        <p className="text-slate-400 mb-6">Begin your transformative journey</p>
                        <Link
                            href="/student/batch2/upanishads/kena"
                            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-amber-500 text-slate-900 font-bold hover:bg-amber-400 transition-colors"
                        >
                                ...
                                <div className="flex items-start justify-between gap-4">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-slate-400">{session.mantra}</p>
                                            {session.reflections && (
                                                <p className="text-xs text-slate-500 mt-2 italic">"{session.reflections}"</p>
                                            )}
                                        </div>
                                    </div>
                ...
                {sessions.length > 0 && (
                    <div className="text-center mt-10">
                        <Link
                            href="/student/batch2/upanishads/kena"
                            className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 text-slate-900 font-bold text-lg hover:from-amber-400 hover:to-orange-400 transition-all shadow-lg shadow-amber-500/20"
                        >
