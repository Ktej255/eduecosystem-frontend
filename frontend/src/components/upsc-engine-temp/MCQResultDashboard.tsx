    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground dark:text-muted-foreground">Here is your performance report</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card className="md:col-span-1 border-t-4 border-t-blue-500">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">{results.score} out of {results.totalQuestions} correct</p>
                    </CardContent>
                </Card>

                <Card className="md:col-span-1 border-t-4 border-t-red-500">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-medium text-muted-foreground">Reasoning Gap</CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="md:col-span-1 border-t-4 border-t-yellow-500">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-medium text-muted-foreground">Luck Factor</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="flex items-center gap-2 mb-2">
                        ...
                        {questions.map((q, idx) => {
                            ...
                            return (
                                <div key={idx} className={`p-4 rounded-lg border ${isCorrect ? 'bg-green-50/50 border-green-100' : 'bg-red-50/50 border-red-100'}`}>
                                    ...
                                    <div className="ml-8 mt-2 text-sm text-muted-foreground space-y-1">
                                        ...
                                        <div className="mt-2 p-3 bg-card dark:bg-black/20 rounded border border-border">
                                            <span className="font-bold text-xs text-muted-foreground uppercase">Explanation</span>
