...
export default function AntiGravityDashboard() {
    ...
    const fetchDashboard = async () => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/v1/antigravity/dashboard`);
    ...
    const toggleSlot = async (slot: SlotTask) => {
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/v1/antigravity/progress/toggle`, {
                method: 'POST',
                        ...
                        <button
                            onClick={async () => {
                                try {
                                    ...
                                    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/v1/antigravity/test/sunday`);
