        ...
        <Card className="col-span-1 md:col-span-3 lg:col-span-4 border-indigo-100 shadow-sm bg-gradient-to-br from-white to-slate-50">
            <CardHeader className="flex flex-row items-center justify-between pb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <CardTitle className="text-lg font-bold text-foreground">Operation Lakshmikant</CardTitle>
                        <p className="text-xs text-muted-foreground font-medium tracking-wide uppercase">Production Pipeline</p>
                    </div>
                </div>
                <div className="flex gap-2">
                    <div className="hidden md:flex items-center gap-2 text-xs font-medium bg-card px-3 py-1.5 rounded-lg border border-border text-muted-foreground shadow-sm">
                            ...
                            <ScrollArea className="flex-1 p-2">
                                <div className="space-y-2">
                                    {groupedTasks[col.id]?.map((task) => (
                                        <div
                                            key={task.id}
                                            className="bg-card p-2.5 rounded-lg border border-border shadow-sm hover:shadow-md transition-all cursor-pointer group relative"
                                        >
                                            ...
                                            <h4 className="text-xs font-semibold text-foreground leading-tight mb-2">
                                                {task.title}
                                            </h4>
