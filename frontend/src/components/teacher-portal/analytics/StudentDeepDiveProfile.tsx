    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-[700px] w-full max-w-6xl mx-auto p-4 md:p-0">
            ...
            <div className="md:col-span-4 lg:col-span-3 space-y-6">
                <Card className="text-center overflow-hidden border-border">
                    ...
                    <div className="relative -mt-12 px-4 pb-4">
                        ...
                        <h2 className="mt-3 text-xl font-bold text-foreground">{studentProfile.name}</h2>
                ...
                <Card className="border-border">
                    <CardHeader className="pb-3">
                        <CardTitle className="text-sm font-bold uppercase tracking-wider text-muted-foreground">Key Stats</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <span className="font-bold text-foreground">#{studentProfile.overallRank}</span>
                        </div>
                        <div className="flex justify-between items-center">
                            <span className="text-sm text-muted-foreground">Date Joined</span>
                            <span className="text-sm text-muted-foreground">{studentProfile.joinDate}</span>
                        </div>
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-9 space-y-6 text-left">
                <Tabs defaultValue="overview" className="h-full flex flex-col">
                    <TabsList className="w-full justify-start bg-transparent border-b border-border rounded-none h-auto p-0 mb-4">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <ScrollArea className="h-[400px] pr-4">
                                    <div className="space-y-6 pl-2 relative border-l-2 border-slate-100 ml-4">
                                        {activityLog.map((log) => (
                                            <div key={log.id} className="relative pl-6">
                                                ...
                                                {log.score && <Badge variant="secondary" className="mt-1 text-[10px] bg-muted">Score: {log.score}</Badge>}
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="space-y-4">
                                    {payments.map(inv => (
                                        <div key={inv.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted transition-colors">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-muted-foreground">{inv.date} • {inv.id.toUpperCase()}</p>
                                                </div>
                                            </div>
