...
export default function SocialPostPreviewer() {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 max-w-6xl mx-auto h-[600px]">
                ...
                <Card className="h-full border-slate-200 dark:border-slate-800">
                    ...
                    <CardContent className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <div className="border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-lg p-8 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors relative">
                                <input
                                    type="file"
                                    accept="image/*"
            ...
            {/* Preview Panel */}
            <div className="lg:col-span-8 h-full flex flex-col justify-center items-center bg-slate-100 dark:bg-slate-950 rounded-xl border border-slate-200 dark:border-slate-800 p-8">
                <Tabs defaultValue="instagram" className="w-full max-w-sm">
                    ...
                    <TabsContent value="instagram">
                        <div className="bg-white text-black border border-slate-200 rounded-xl overflow-hidden shadow-xl max-w-sm mx-auto">
                            {/* Header */}
                            ...
                            <div className="p-3">
                                <div className="flex items-center justify-between mb-2">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <MessageCircle className="h-6 w-6 -rotate-90 hover:text-slate-600 cursor-pointer" />
                                        <Send className="h-6 w-6 hover:text-slate-600 cursor-pointer" />
                                    </div>
                                    <Bookmark className="h-6 w-6 hover:text-slate-600 cursor-pointer" />
                                </div>
                                ...
                                <p className="text-[10px] text-slate-400 uppercase mt-2">2 HOURS AGO</p>
                            </div>
                        </div>
                    </TabsContent>
                        ...
                        <div className="bg-white text-black border border-slate-200 rounded-xl overflow-hidden shadow-xl max-w-sm mx-auto">
                            ...
                            <div className="flex items-center gap-3 p-3 pb-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500 mt-0.5">15,420 followers</p>
                                    <div className="flex items-center gap-1 text-xs text-slate-500 mt-0.5">
                                        <span>2h •</span>
                                        <Globe className="h-3 w-3" />
                                    </div>
                                </div>
                                <Button variant="ghost" size="icon" className="ml-auto h-8 w-8 text-slate-500">
                            ...
                            {/* Image */}
                            <div className="aspect-[4/3] bg-slate-100 flex items-center justify-center overflow-hidden border-y border-slate-100">
                                {image ? (
                                    <img src={image} alt="Post" className="w-full h-full object-cover" />
                                ) : (
                                    <div className="flex flex-col items-center text-slate-400">
                            ...
                            <div className="px-3 py-2 flex items-center justify-between border-t border-slate-100">
                                <Button variant="ghost" size="sm" className="flex-1 text-slate-600 gap-1.5 h-10 hover:bg-slate-100">
