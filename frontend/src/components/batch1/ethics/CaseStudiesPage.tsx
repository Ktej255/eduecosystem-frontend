            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Apply the 5-step framework to resolve ethical dilemmas.</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 opacity-50 pointer-events-none">
                    <div className="p-6 border border-dashed border-border rounded-xl text-center">
                        <h3 className="font-bold text-muted-foreground">Scenario 1: Riot Control</h3>
                        <p className="text-xs text-muted-foreground">Locked</p>
                    </div>
                    <div className="p-6 border border-dashed border-border rounded-xl text-center">
                        <h3 className="font-bold text-muted-foreground">Scenario 2: Whistleblowing</h3>
                        <p className="text-xs text-muted-foreground">Locked</p>
                    </div>
                </div>
            </div>
