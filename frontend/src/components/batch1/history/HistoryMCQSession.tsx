...
export default function HistoryMCQSession({
    ...
    return (
        <div className="flex flex-col h-full bg-slate-50 dark:bg-black overflow-hidden rounded-3xl relative">
            <div className="flex flex-1 overflow-hidden">
                ...
                <div className={`
                    absolute inset-0 z-50 bg-white dark:bg-slate-950 md:relative md:w-72 md:bg-slate-50 md:dark:bg-slate-900/50 md:border-l border-slate-200 dark:border-slate-800 flex flex-col transition-transform duration-300
                ...
                `}>
                    ...
                    <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
                        <div className="grid grid-cols-4 gap-3">
                            {questions.map((q, idx) => {
                                ...
                                let bgClass = 'bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-500';
                    ...
                    <div className="p-6 border-t border-slate-200 dark:border-slate-800 text-xs text-slate-500 space-y-3 bg-slate-50 dark:bg-slate-900">
