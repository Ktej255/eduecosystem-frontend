...
export const MODERN_CHAPTER_2_MCQS: any[] = [
    {
        ...
        "options": [
            "A celebration of India's scientific achievements.",
            "Viewing India as a dynamic, evolving society equal to the West.",
            "Viewing India as a stagnant, backward society requiring Western guidance.",
    ...
    },
    {
        ...
        "options": [
            "It emphasizes the exploitative nature of British rule.",
            "It justifies colonial rule as a mission to civilize a 'bickering' society.",
            "It focuses on the class struggle within Indian society.",
    ...
    },
    {
        ...
        "options": [
            "The theory that Indian society evolved naturally like a biological organism.",
            "The belief that the English were superior and 'fittest to rule'.",
            "The study of Indian social structures.",
    ...
    },
    {
        ...
        "options": [
            "A British peace treaty with the Marathas.",
            "The law and order allegedly brought by British rule to India.",
    ...
    },
    {
        ...
        "options": [
            "It praised Indian culture.",
            "It was the first Marxist interpretation.",
            "It set the tone for the colonial critique of indigenous society.",
    ...
    },
    {
        ...
        "options": [
            "Support to the Colonial approach.",
            "Response to and confrontation with the Colonial approach.",
    ...
    },
    {
        ...
        "options": [
            "It emphasizes religious conflict.",
            "It seeks to unify people against colonial rule.",
            "It focuses solely on the elite.",
    ...
    },
    {
        ...
        "options": [
            "India Today and Social Background of Indian Nationalism",
            "The Discovery of India and Hind Swaraj",
            "Poverty and Un-British Rule and Economic History of India",
    ...
    },
    {
        ...
        "options": [
            "Only the anti-imperialist struggle.",
            "The benevolent nature of British rule.",
            "Inner contradictions (class struggle) within Indian society.",
    ...
    },
    {
        ...
        "options": [
            "Being too pro-British.",
            "Being a simplistic version of the class approach.",
            "Ignoring the role of the working class.",
    ...
    },
    {
        ...
        "options": [
            "It is too focused on economics.",
            "It had an elitist bias and ignored the voice of the people.",
            "It was too critical of the British.",
    ...
    },
    {
        ...
        "options": [
            ...
            "Hindus and Muslims.",
            "The Elite (Indian & Foreign) and the Subaltern groups.",
    ...
    },
    {
        ...
        "options": [
            "As the true representative of all Indians.",
            "As a cloak for the struggle for power among the elite.",
            "As a socialist organization.",
            "As a British stooge."
        ],
        "correctAnswer": 1,
    ...
    },
    {
        ...
        "options": [
            "The masses were important.",
            "Indian society should be seen in terms of class alone.",
            "The British were exploitative.",
    ...
    },
    {
        ...
        "options": [
            "A period of syncretic culture.",
            "A golden age of economic prosperity.",
            "One long story of Hindu-Muslim conflict.",
    ...
    },
    {
        ...
        "options": [
            ...
            "Feminist historiography/Women's history",
            "Communalist writing",
            "Subaltern studies"
        ],
        "correctAnswer": 1,
    ...
    },
    {
        ...
        "options": [
            "A nationalist defence of Indian culture.",
            "A colonial critique that attracted international attention.",
            "A Marxist analysis of Indian poverty.",
    ...
    },
    {
        ...
        "options": [
            ...
            "How colonial structures (like law) affected women's lives.",
    ...
    },
    {
        ...
        "options": [
            "Ranajit Guha - Colonial",
            "R.P. Dutt - Marxist",
            "Vincent Smith - Subaltern",
    ...
    },
    {
        ...
        "options": [
            "Denial of ownership of productive resources.",
    ...
    },
    {
        ...
        "options": [
            "It focused too much on the economic exploitation by the British.",
            "It ignored the internal contradictions of Indian society, such as caste and class oppression.",
            "It portrayed the British rule as entirely beneficial for India's modernization.",
            "It completely neglected the role of the educated middle class."
        ],
        "correctAnswer": 1,
    ...
    },
    {
        ...
        "options": [
            ...
            "The interests of the Indian people and the British colonial interests.",
            "The Indian peasantry and the Indian landlords.",
            "The Upper Caste elite and the Dalits."
        ],
        "correctAnswer": 1,
    ...
    },
    {
        ...
        "options": [
            "History is shaped primarily by the decisions of the Governor-Generals.",
            "The Indian National Congress fully represented the aspirations of the masses.",
            "There is a basic contradiction between the elite (both colonial and indigenous) and the masses (subalterns).",
            "Religious identity is the sole driving force of Indian history."
        ],
        "correctAnswer": 2,
    ...
    },
    {
        ...
        "options": [
            "Ignores the economic factor completely.",
            "Rejects the notion that the 'people' had their own independent agency.",
            "Criticizes the Marxist view for merging the distinct voice of the masses with the elite nationalist movement.",
            "Supports the Colonial claim of a 'Civilizing Mission'."
        ],
        "correctAnswer": 2,
    ...
    },
    {
        ...
        "options": [
            "A golden age of synthesis.",
            "A period of foreign rule and decline of Indian civilization.",
            "A period of rapid industrialization.",
            "The age of the rise of Maratha power only."
        ],
        "correctAnswer": 1,
    ...
    },
    {
        ...
        "options": [
            "Biographies of queens like Rani Laxmibai only.",
            "The participation of women in the non-cooperation movement only.",
            "The structural analysis of gender discrimination and women's role in the household and society.",
            "The role of British women in the colonial administration."
        ],
        "correctAnswer": 2,
    ...
    },
    {
        ...
        "options": [
            "Neo-liberals exaggerate the poverty of India.",
            "Neo-liberals ignore the destruction of indigenous handicrafts and the 'Drain of Wealth'.",
            "Neo-liberals focus too much on the role of religion.",
            "Neo-liberals deny the existence of the railway network."
        ],
        "correctAnswer": 1,
    ...
    },
    {
        ...
        "options": [
            "It acknowledges that women were active agents in history, not just passive victims.",
            "It seeks to uncover the history of women's organizations like the All India Women's Conference.",
            "It argues that the National Movement fully resolved the issue of gender inequality.",
            "It critiques the patriarchal bias in traditional history writing."
        ],
        "correctAnswer": 2,
