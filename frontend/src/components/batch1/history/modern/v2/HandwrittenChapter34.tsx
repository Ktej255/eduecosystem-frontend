...
import { ch34 } from './translations/ch34';

export default function HandwrittenChapter34() {
    const { language } = useLanguageStore();
    const t = ch34[language as keyof typeof ch34] || ch34.en;
                ...
                <section key={sIdx} className="max-w-4xl mx-auto mb-12 handwritten-paper p-8 paper-border bg-paper relative">
                    ...
                    <div className="space-y-6">
                        ...
                        {section.cards && section.cards.map((card, cIdx) => (
                            <div key={cIdx} className="bg-paper-orange/10 p-4 paper-border border shadow-sm">
                                <h3 className="text-xl font-bold text-paper-red mb-2">{card.title}</h3>
