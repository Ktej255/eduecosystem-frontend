            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
                ...
                <div className="lg:col-span-6 space-y-8">
                    ...
                    <div className="pamphlet-card p-6 border-t-8 border-gray-800 relative">
                        ...
                        <p className="text-sm mb-4 leading-relaxed">{t.warText}</p>
                        <div className="bg-gray-100 p-4 border-l-4 border-black text-sm relative">
                            <div className="absolute -right-2 -top-2 bg-black text-white px-2 py-0.5 text-[10px] font-bold">{t.realityCheck}</div>
                            <strong>{t.realityStrong}</strong>
                            <ul className="mt-2 space-y-1 list-disc ml-4 text-xs text-gray-700">
                                {t.realityItems.map((item, i) => (
                                    <li key={i}>{item}</li>
                                ))}
                                <li><strong>{t.realityNeed}</strong>{t.realityNeedText}<span className="bg-green-200 px-1 font-bold">{t.selfGov}</span>.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="pamphlet-card p-0 overflow-hidden relative">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div className="bg-orange-50 p-6 border-b md:border-b-0 md:border-r border-orange-200 relative">
                                ...
                                <h3 className="headline-font text-2xl font-bold text-orange-800 mb-2 mt-2">{t.tilakTitle}</h3>
                                <div className="text-[10px] font-bold uppercase mb-4 text-orange-600 bg-orange-100 inline-block px-1">{t.tilakMeta}</div>
                                <ul className="text-xs space-y-3 list-disc ml-4 font-medium text-gray-800">
                                    ...
                                    <li><strong>{t.tilakOrg}</strong> <span className="bg-orange-200 px-1 border border-orange-400">{t.tilakBranches}</span>{t.tilakBranchNote}</li>
                                </ul>
                            </div>
                            ...
                            <div className="bg-green-50 p-6 relative">
                                ...
                                <h3 className="headline-font text-2xl font-bold text-green-800 mb-2 mt-2">{t.besantTitle}</h3>
                                <div className="text-[10px] font-bold uppercase mb-4 text-green-600 bg-green-100 inline-block px-1">{t.besantMeta}</div>
                                <ul className="text-xs space-y-3 list-disc ml-4 font-medium text-gray-800">
                                    {t.besantItems.map((item, i) => (
                                        <li key={i}><strong>{item.bold}</strong>{item.text}</li>
                                    ))}
                                    <li><strong>{t.besantOrg}</strong> <span className="bg-green-200 px-1 border border-green-400">{t.besantBranches}</span>{t.besantBranchNote}</li>
                                </ul>
                    ...
                    <div className="pamphlet-card p-6 bg-red-50 border-2 border-red-100 relative">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h4 className="font-bold text-sm text-red-800">{t.besantArrest}</h4>
                                    <p className="text-xs text-gray-700 mt-1">{t.besantArrestText}</p>
                                </div>
                            </div>

                            <div className="border-l-4 border-red-800 pl-4 py-1">
                                <h4 className="font-bold text-sm">{t.renunciationTitle}</h4>
                                <p className="text-xs italic bg-white p-1 inline-block border border-gray-200 mt-1">{t.renunciationQuote}</p>
                                <p className="text-[10px] font-bold mt-1 uppercase text-red-700">{t.renunciationBy}</p>
                            </div>
                            ...
                            <div className="bg-white p-3 border border-red-200 shadow-sm relative">
                                <div className="absolute -top-2 -right-2 transform rotate-3">
                                    <Badge variant="outline" className="bg-white border-red-800 text-red-800 font-bold text-[10px]">{t.walkoutBadge}</Badge>
                                </div>
                                <h4 className="font-bold text-sm text-red-700 uppercase">{t.warConference}</h4>
                                <p className="text-xs mt-1">{t.warConferenceText}<span className="font-bold">{t.warConferenceWalkout}</span>.</p>
                            </div>

                            <div className="bg-green-100 p-3 border border-green-300 text-center">
                                <h4 className="font-bold text-sm text-green-800 uppercase">{t.carrotTitle}</h4>
                                <p className="text-xs mt-1">{t.carrotText}<span className="font-bold bg-white px-1">{t.selfGovInst}</span>{t.carrotEnd}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-6 space-y-8">
                    ...
                    <div className="border-4 border-black p-4 bg-gray-100 text-center relative max-w-sm mx-auto transform -rotate-1">
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-black text-white px-2 py-0.5 text-[10px] font-bold uppercase">{t.obituaryTag}</div>
                        ...
                        <div className="text-xs border-t border-gray-400 pt-2 mt-2">
                            <strong>{t.obituaryEffect}</strong>{t.obituaryEffectText}
                        </div>
                    </div>
                    ...
                    <div className="pamphlet-card p-6 relative overflow-hidden">
                        <div className="unity-gradient h-16 w-full absolute top-0 left-0 flex items-center justify-center">
                            <div className="bg-white/90 px-4 py-1 rounded shadow-sm">
                                <h3 className="headline-font text-2xl font-bold uppercase tracking-widest text-gray-900">{t.lucknowTitle}</h3>
                            </div>
                        </div>

                        <div className="mt-12 text-center mb-6">
                            <p className="text-sm italic font-serif text-gray-600">{t.lucknowQuote}</p>
                        </div>

                        <div className="grid grid-cols-2 gap-4 text-sm mb-6">
                            <div className="bg-purple-50 p-4 border border-purple-200">
                                <strong className="text-purple-900 uppercase text-xs block mb-2">{t.doubleUnity}</strong>
                            ...
                            <div className="bg-purple-50 p-4 border border-purple-200">
                                <strong className="text-purple-900 uppercase text-xs block mb-2">{t.keyArchitect}</strong>
                                <p className="font-bold text-lg">{t.jinnahName}</p>
                                <p className="text-[10px] italic mt-1">{t.jinnahQuote}</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-red-50 p-4 text-xs border border-red-200 text-gray-800">
                            ...
                            {t.blunderText}<span className="font-bold bg-red-100 px-1">{t.separateElectorates}</span>.
                            <br /><em className="text-gray-500 mt-1 block">{t.blunderCriticism}</em>
                        </div>
                    </div>
                    ...
                    <div className="pamphlet-card p-6">
                        ...
                        <div className="grid gap-4">
                            <div className="flex justify-between items-center bg-gray-50 p-3 border border-gray-200">
                                <div>
                                    <h4 className="font-bold text-sm text-purple-900">{t.firstWoman}</h4>
                                    <p className="text-xs text-gray-600">{t.firstWomanText}</p>
                                </div>
                                <BadgeCheck className="w-6 h-6 text-purple-300" />
                            </div>

                            <div className="bg-blue-50 p-3 border border-blue-200">
                                <h4 className="font-bold text-sm text-blue-900">{t.bombayHero}</h4>
                                <p className="text-xs text-gray-800 mt-1">{t.bombayHeroText}<strong>{t.antiWillingdon}</strong>.</p>
                            ...
                            <div className="flex gap-4">
                                <div className="flex-1 bg-yellow-50 p-3 border border-yellow-200">
                                    <h4 className="font-bold text-sm text-yellow-800 mb-1">{t.biAmman}</h4>
                                    <p className="text-[10px] leading-tight">{t.biAmmanText}</p>
                                </div>
                                <div className="flex-1 bg-gray-50 p-3 border border-gray-200">
                                    <h4 className="font-bold text-sm text-gray-800 mb-1">{t.chirolCase}</h4>
                                    <p className="text-[10px] leading-tight">{t.chirolText}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white border-2 border-gray-800 p-4">
                        <h4 className="font-bold text-sm uppercase mb-3 text-center bg-gray-800 text-white py-1 spartan-font">{t.analysisTitle}</h4>
                        <div className="grid grid-cols-3 gap-2 text-xs text-center font-bold uppercase bg-gray-100 py-2 mb-2">
                            ...
                            <span className="text-orange-600">{t.swadeshiLabel}</span>
                            <span className="text-green-600">{t.homeRuleLabel}</span>
                        </div>
                        <div className="space-y-2 text-xs">
                            {t.analysisRows.map((row, i) => (
                                <div key={i} className={`grid grid-cols-3 gap-2 text-center ${i < t.analysisRows.length - 1 ? 'border-b border-gray-200 pb-2' : ''}`}>
                                    <span className="font-bold text-gray-500">{row.feature}</span>
                                    <span>{row.swadeshi}</span>
                                    <span className="font-bold bg-green-100">{row.homeRule}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="bg-[#2c2c2c] text-gray-100 p-6 relative overflow-hidden rounded-sm">
                        ...
                        <h3 className="spartan-font text-xl font-bold mb-2 text-yellow-400 uppercase">{t.transitionTitle}</h3>
                        <p className="text-sm mb-4 text-gray-300">{t.transitionText}</p>
                        ...
                        <div className="flex items-center gap-4 bg-white/10 p-3 rounded border border-white/20">
                            ...
                            <div className="text-[10px] md:text-xs">
                                ...
                                <div className="mt-1 flex items-center gap-2">
                                    <span className="px-1 bg-yellow-400 text-black font-bold uppercase text-[10px]">{t.renamedTo}</span>
                                    <span className="font-bold uppercase tracking-wider">{t.swarajyaSabha}</span>
                                </div>
                            </div>
                        </div>
                    </div>
