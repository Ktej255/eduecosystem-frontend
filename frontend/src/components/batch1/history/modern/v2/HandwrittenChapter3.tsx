        ...
        <div className="min-h-screen bg-[#fdfbf7] p-4 md:p-8 font-['Kalam',_cursive] text-[#003366] selection:bg-orange-100 overflow-x-hidden">
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mb-20 relative z-10">
                ...
                <div className="bg-slate-100 p-8 paper-border border-2 border-slate-300 flex flex-col items-center justify-center text-center group cursor-pointer hover:bg-slate-50 transition-colors">
                    ...
                    <h3 className="marker-label text-2xl text-slate-600 mb-2 font-['Permanent_Marker']">{t.mapTitle}</h3>
                    <p className="text-slate-500 italic max-w-xs">{t.mapText}</p>
                    <Badge variant="outline" className="mt-4">{t.mapBadge}</Badge>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20 relative z-10">
                ...
                <section className="bg-white p-8 paper-border border-b-8 border-r-8 border-[#003366] transform -rotate-1 hover:rotate-0 transition-transform">
                    <div className="flex justify-between items-start mb-6">
                        ...
                        <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-bold">{t.portYears}</span>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <Card className="bg-white paper-border border-slate-200 shadow-sm transform -rotate-1">
                                <CardContent className="p-4">
                                    <h4 className="font-bold border-b mb-2">{t.almeidaTitle} <span className="text-xs italic">{t.almeidaYears}</span></h4>
                                    <p className="text-sm">{t.almeidaText}</p>
                                </CardContent>
                            </Card>
                            <Card className="bg-white paper-border border-slate-200 shadow-sm transform rotate-1">
                                <CardContent className="p-4">
                                    <h4 className="font-bold border-b mb-2">{t.albuquerqueTitle} <span className="text-xs italic">{t.albuquerqueYears}</span></h4>
                                    <p className="text-sm">{t.albuquerqueText}</p>
                                </CardContent>
                            </Card>
                        </div>

                        <div className="p-4 bg-orange-50 border-orange-200 border rounded-lg italic text-sm">
                            <span className="font-bold text-[#CC5500]">{t.culturalLegacy}</span>
                ...
                <div className="space-y-12">
                    ...
                    <section className="bg-white p-8 paper-border border-b-8 border-r-8 border-orange-500 transform rotate-1 hover:rotate-0 transition-transform">
                        <div className="flex justify-between items-start mb-6">
                            <h2 className="text-3xl font-['Permanent_Marker'] text-orange-700">{t.dutchTitle}</h2>
                            <span className="bg-orange-100 text-orange-800 px-3 py-1 rounded-full text-sm font-bold">{t.dutchYears}</span>
                        </div>
                        ...
                        <div className="bg-stone-50 p-4 paper-border border-dashed border-stone-300 mb-4">
                            <h4 className="marker-label text-sm uppercase mb-2">{t.dutchCommoditiesTitle}</h4>
                            <div className="flex flex-wrap gap-2">
                                {t.dutchCommodities.map((item, i) => (
                                    <Badge key={i} className="bg-stone-600">{item}</Badge>
                                ))}
                            </div>
                        </div>
                    ...
                    <section className="bg-red-50 p-6 paper-border border-2 border-red-200 transform -rotate-1">
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <h3 className="text-xl font-bold text-red-900 marker-label tracking-tighter uppercase">{t.danesTitle}</h3>
                        </div>
                ...
                <section className="lg:col-span-2 bg-white p-10 paper-border border-b-8 border-r-8 border-[#003366] relative overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                        ...
                        <div className="flex flex-col items-end">
                            <span className="bg-blue-100 text-blue-900 px-4 py-1 rounded-full text-lg font-bold">{t.engYears}</span>
                            <span className="text-[10px] uppercase font-bold text-slate-400 mt-1">{t.engCompany}</span>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
                        ...
                        <div className="bg-slate-50 p-6 paper-border border-2 border-slate-200 relative overflow-hidden group">
                            ...
                            <h3 className="marker-label text-blue-800 text-xl mb-3">{t.madras}</h3>
                        ...
                        <div className="bg-slate-50 p-6 paper-border border-2 border-slate-200 relative group">
                            ...
                            <h3 className="marker-label text-indigo-800 text-xl mb-3">{t.bombay}</h3>
                        ...
                        <div className="bg-slate-50 p-6 paper-border border-2 border-slate-200 relative group">
                            ...
                            <h3 className="marker-label text-cyan-800 text-xl mb-3">{t.calcutta}</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center bg-blue-900 p-8 rounded-3xl text-white">
                        <div>
                            ...
                            <p className="body-handwritten text-xl text-blue-100 leading-relaxed">
                                <span className="font-bold text-white">{t.farmansName}</span> {t.magnaCartaText}
                            </p>
                        ...
                        <div className="space-y-3 bg-white/10 p-4 rounded-xl body-handwritten text-sm">
                            <p className="font-bold border-b border-white/20 pb-1 uppercase tracking-widest text-orange-400">{t.milestonesTitle}</p>
                            {t.milestones.map((m, i) => (
                                <p key={i}>• <span className="marker-yellow text-slate-900">{m.year}</span> {m.text}</p>
                            ))}
                        </div>
                    </div>
                </section>
                ...
                <section className="bg-white p-8 paper-border border-b-8 border-r-8 border-purple-800 transform rotate-1 hover:rotate-0 transition-transform">
                    <div className="flex justify-between items-start mb-6">
                        <h2 className="text-3xl font-['Permanent_Marker'] text-purple-900">{t.frenchTitle}</h2>
                        <span className="bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm font-bold">{t.frenchYears}</span>
                    </div>
                ...
                <section className="bg-[#f0f9ff] p-8 paper-border border-2 border-blue-300 relative">
                    ...
                    <div className="space-y-8 relative">
                        ...
                        <div className="relative pl-12 group">
                            ...
                            <h3 className="marker-label text-xl mb-1 flex items-center gap-2">{t.war1Title} <span className="text-xs font-sans font-bold text-slate-400 tracking-tighter">{t.war1Years}</span></h3>
                            <p className="body-handwritten text-sm text-slate-600">{t.war1Text}</p>
                        </div>

                        {/* Second War */}
                        <div className="relative pl-12 group">
                            <div className="absolute left-4 top-2 w-4 h-4 rounded-full bg-blue-500 border-2 border-white group-hover:scale-125 transition-transform"></div>
                            <h3 className="marker-label text-xl mb-1 flex items-center gap-2">{t.war2Title} <span className="text-xs font-sans font-bold text-slate-400 tracking-tighter">{t.war2Years}</span></h3>
                            <p className="body-handwritten text-sm text-slate-600">{t.war2Text}</p>
                        </div>
                        ...
                        <div className="relative pl-12 group">
                            ...
                            <h3 className="marker-label text-xl mb-1 flex items-center gap-2 text-red-800 uppercase italic">{t.war3Title} <span className="text-xs font-sans font-bold text-slate-400 tracking-tighter">{t.war3Years}</span></h3>
                            <p className="body-handwritten text-sm text-slate-600">{t.war3Text}</p>
                        </div>
                    </div>
                </section>
            </div>
            ...
            <section className="max-w-5xl mx-auto mb-20">
                <div className="bg-slate-900 p-8 rounded-[40px] text-white overflow-hidden relative shadow-2xl">
                    ...
                    <h2 className="marker-label text-3xl mb-8 text-center text-orange-400">{t.comparisonTitle}</h2>
                            ...
                            <tbody>
                                {t.tableRows.map((row, i) => (
                                    <tr key={i} className="bg-white/5 rounded-xl">
                                        <td className="p-4 font-bold text-orange-200">{row[0]}</td>
            ...
            <footer className="text-center pb-12 px-4">
                <div className="max-w-xs mx-auto flex flex-col items-center">
                    ...
                    <p className="marker-label text-slate-400 uppercase text-xs tracking-[0.3em] font-bold">{t.footerLog}</p>
                    <p className="body-handwritten italic text-slate-400 text-sm mt-2">{t.footerArchive}</p>
                </div>
            </footer>
        </div>
    );
