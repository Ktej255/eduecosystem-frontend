                        ...
                        <div className="sticky top-24 space-y-4">
                            <Card className="border-slate-200 dark:border-slate-800 shadow-sm">
                                <CardHeader className="pb-2 bg-slate-50 dark:bg-slate-900/50">
                                    <CardTitle className="text-xs uppercase tracking-wider text-slate-500 font-bold">Key Dimensions</CardTitle>
                                </CardHeader>
                                    ...
                                    {content.sections.map((sec, idx) => (
                                        <button
                                            ...
                                            className={`w-full text-left px-3 py-2 rounded-lg text-sm font-medium transition-colors ${activeSection === sec.heading
                                                ...
                                                : 'text-slate-600 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800 border-l-2 border-transparent'
                                                }`}
                                        >
                                            {sec.heading}
                                        </button>
                            ...
                            <div className="flex justify-center pt-8 pb-16">
                                {!isCompleted ? (
                                    ...
                                    <div className="flex flex-col items-center gap-4">
                                        ...
                                        <p className="text-slate-500 text-sm">Strategic depth analysis recorded.</p>
