                    ...
                    <Card className="sticky top-24 border-indigo-100 dark:border-indigo-900">
                        ...
                        <CardContent className="space-y-2 p-4 pt-0">
                            {BILATERAL_CONTENT.sections.map(sec => (
                                <a key={sec.id} href={`#${sec.id}`} className="block text-sm font-medium text-slate-700 dark:text-slate-300 hover:text-emerald-600 dark:hover:text-emerald-400 p-2 rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-colors">
                                    {sec.title}
                                </a>
                            ))}
                        </CardContent>
