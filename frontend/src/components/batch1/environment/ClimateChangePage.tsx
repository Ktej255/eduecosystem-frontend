                ...
                <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">{CLIMATE_CONTENT.description}</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <Card className="sticky top-24">
                            ...
                            <CardContent className="space-y-2 p-4 pt-0">
                                {CLIMATE_CONTENT.sections.map(sec => (
                                    <a key={sec.id} href={`#${sec.id}`} className="block text-sm font-medium text-muted-foreground hover:text-orange-600 dark:hover:text-orange-400 p-2 rounded-lg hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-colors">
                                        {sec.title}
                                    </a>
                                ))}
                            </CardContent>
