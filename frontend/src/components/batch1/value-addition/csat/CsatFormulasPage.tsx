            ...
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Quick revision for Quantitative Aptitude.</p>
                    </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Number System */}
                    <Card className="dark:bg-[#0a0a0a] border-border">
                        <CardHeader>
                        ...
                        <CardContent className="space-y-4 text-sm">
                            <div className="p-3 bg-muted rounded-lg">
                                ...
                                <code className="text-violet-600 bg-card dark:bg-black px-2 py-1 rounded">n(n+1)/2</code>
                            </div>
                            <div className="p-3 bg-muted rounded-lg">
                                <span className="font-bold block mb-1">Sum of first n odd numbers:</span>
                                <code className="text-violet-600 bg-card dark:bg-black px-2 py-1 rounded">n²</code>
                            </div>
                            <div className="p-3 bg-muted rounded-lg">
                                <span className="font-bold block mb-1">Divisibility by 3:</span>
                                <span className="text-muted-foreground dark:text-muted-foreground">Sum of digits is divisible by 3.</span>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="dark:bg-[#0a0a0a] border-border">
                        ...
                        <CardContent className="space-y-4 text-sm">
                            <div className="p-3 bg-muted rounded-lg">
                                ...
                                <code className="text-emerald-600 bg-card dark:bg-black px-2 py-1 rounded">πr²  |  2πr</code>
                            </div>
                            <div className="p-3 bg-muted rounded-lg">
                                <span className="font-bold block mb-1">Cylinder Volume:</span>
                                <code className="text-emerald-600 bg-card dark:bg-black px-2 py-1 rounded">πr²h</code>
                            </div>
                            <div className="p-3 bg-muted rounded-lg">
                                <span className="font-bold block mb-1">Sphere Volume:</span>
                                <code className="text-emerald-600 bg-card dark:bg-black px-2 py-1 rounded">4/3 πr³</code>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="dark:bg-[#0a0a0a] border-border">
                        ...
                        <CardContent className="space-y-4 text-sm">
                            <div className="p-3 bg-muted rounded-lg">
                                ...
                                <code className="text-amber-600 bg-card dark:bg-black px-2 py-1 rounded">nPr = n! / (n-r)!</code>
                            </div>
                            <div className="p-3 bg-muted rounded-lg">
                                <span className="font-bold block mb-1">Combination (Selection):</span>
                                <code className="text-amber-600 bg-card dark:bg-black px-2 py-1 rounded">nCr = n! / r!(n-r)!</code>
                            </div>
                        </CardContent>
                    </Card>
                </div>
