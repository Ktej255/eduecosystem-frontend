    ...
    const phases = [
        {
            ...
            action: { label: "Start Now", link: `/student/batch1-1/${weekId}/${dayId}/pomodoro` },
        ...
        },
        {
            ...
            action: isSaturday
                ? { label: "Start Test", link: `/student/batch1-1/${weekId}/saturday-test` }
                : { label: "Start Session", link: `/student/batch1-1/${weekId}/${dayId}/pomodoro` },
        ...
        },
        {
            ...
            action: { label: "Start Now", link: `/student/batch1-1/${weekId}/${dayId}/evening` },
                ...
                <div key={phase.id} className="relative flex flex-col md:flex-row gap-6 md:gap-8 group">
                    ...
                    <div className="absolute left-0 md:relative md:left-auto flex-shrink-0 z-10 bg-white dark:bg-gray-900 py-2">
                        <div className={`w-14 h-14 rounded-full border-[3px] flex items-center justify-center text-xl font-bold shadow-sm transition-transform group-hover:scale-110 
                            ...
                            border-${phase.color}-200 text-${phase.color}-400 bg-white dark:bg-gray-800`}>
                            {phase.id}
                        </div>
                    </div>
