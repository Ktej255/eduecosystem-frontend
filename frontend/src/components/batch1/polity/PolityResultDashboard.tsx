...
export default function PolityResultDashboard({
    ...
    return (
        <div className="max-w-7xl mx-auto px-6 py-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <div className="bg-card dark:bg-[#111] rounded-3xl border border-border shadow-2xl overflow-hidden mb-12">
                <div className="p-6 border-b border-border bg-gray-50/50 dark:bg-card/5 flex items-center justify-between">
                    ...
                    <span className="text-xs font-bold text-muted-foreground uppercase">Interactive Gap Analysis</span>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                ...
                <div className="bg-card dark:bg-[#111] rounded-3xl border border-border shadow-xl p-8 relative overflow-hidden">
                        ...
                        {isHighStress && (
                            <div className="bg-red-50 dark:bg-red-900/20 rounded-xl p-4 border border-red-100 dark:border-red-900/50">
                                ...
                                <Link href="/student/graphotherapy" className="w-full">
                                    <button className="w-full bg-card dark:bg-black text-red-600 font-bold py-3 rounded-lg shadow-sm hover:shadow hover:scale-[1.02] transition-all text-sm">
                        ...
                        {isLevel1Passed ? (
                            <>
                                ...
                                <button
                                    ...
                                    className="w-full bg-card text-blue-900 font-black py-4 rounded-xl shadow-xl hover:bg-blue-50 transition-all flex items-center justify-center gap-2 text-lg"
                                >
                            ...
                            <>
                                ...
                                <p className="text-muted-foreground dark:text-muted-foreground mb-8 max-w-sm">
                                ...
                                <button
                                    ...
                                    className="w-full bg-gray-900 dark:bg-card text-white dark:text-black font-bold py-4 rounded-xl shadow-lg hover:opacity-90 transition-all flex items-center justify-center gap-2"
                                >
