...
export default function UnlockModal({ isOpen, onClose, onUnlock, level }: UnlockModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white dark:bg-[#111] rounded-2xl shadow-2xl max-w-md w-full overflow-hidden border border-gray-200 dark:border-gray-800 animate-in zoom-in-95 duration-200">
                {/* Header */}
                ...
                <div className="p-8">
                    <div className="flex items-center justify-center gap-3 mb-8">
                        <span className="text-4xl font-black text-[#1F2937] dark:text-white">{info.price}</span>
                        <span className="text-lg text-gray-400 line-through font-medium">{info.originalPrice}</span>
