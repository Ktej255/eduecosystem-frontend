...
export default function ScienceTechSectionPlanner() {
    ...
    const handleStartSession = () => {
        router.push(`/student/batch1/science-tech/${dayData.topicId}`);
    };

    return (
        <div className="flex flex-col lg:flex-row gap-6 h-[calc(100vh-140px)] min-h-[600px]">
            {/* LEFT SIDE: SCHEDULE LIST */}
            <Card className="w-full lg:w-1/3 flex flex-col border-indigo-200 dark:border-indigo-900 shadow-sm overflow-hidden bg-white dark:bg-slate-900">
                                ...
                                <div
                                    ...
                                    className={`
                                        ...
                                        ${isSelected
                                            ...
                                            : 'bg-white dark:bg-slate-950 border-indigo-100 dark:border-indigo-900 hover:border-indigo-300 dark:hover:border-indigo-700 hover:shadow-sm'
                                        }
                                    `}
                                >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-6">
                            <Card className="border-indigo-100 dark:border-indigo-900 shadow-sm hover:shadow-md transition-all group cursor-pointer" onClick={handleStartSession}>
                                <CardContent className="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-slate-800 mb-1 group-hover:text-indigo-600 transition-colors">Study Material</h4>
                            ...
                            <Card className="border-indigo-100 dark:border-indigo-900 shadow-sm hover:shadow-md transition-all group cursor-pointer" onClick={() => toast.info("MCQs coming soon!")}>
                                <CardContent className="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-slate-800 mb-1 group-hover:text-purple-600 transition-colors">Test Practice</h4>
                                        <p className="text-sm text-slate-500 mb-3">Assessment for {dayData.category} topics.</p>
