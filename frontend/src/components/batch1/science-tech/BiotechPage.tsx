                ...
                <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500">{BIOTECH_CONTENT.description}</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <Card className="top-24 sticky">
                        ...
                        <CardContent className="space-y-2 p-4 pt-0">
                            {BIOTECH_CONTENT.sections.map(sec => (
                                <a key={sec.id} href={`#${sec.id}`} className="block text-sm font-medium text-slate-700 dark:text-slate-300 hover:text-rose-600 dark:hover:text-rose-400 p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                                    {sec.title}
                                </a>
                            ))}
                        </CardContent>
