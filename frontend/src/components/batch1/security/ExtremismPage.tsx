            ...
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500">Left Wing Extremism (LWE) and North-East Insurgency.</p>
                    </div>
                </div>

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {/* LWE Section */}
                    <Card className="dark:bg-[#0a0a0a] border-slate-200 dark:border-slate-800 border-l-4 border-l-red-600">
                        <CardHeader>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="grid grid-cols-2 gap-2 text-xs">
                                    <div className="bg-slate-100 dark:bg-slate-900 p-2 rounded">S - Smart Leadership</div>
                                    <div className="bg-slate-100 dark:bg-slate-900 p-2 rounded">A - Aggressive Strategy</div>
                                    <div className="bg-slate-100 dark:bg-slate-900 p-2 rounded">M - Motivation & Training</div>
                                    <div className="bg-slate-100 dark:bg-slate-900 p-2 rounded">A - Actionable Intelligence</div>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="dark:bg-[#0a0a0a] border-slate-200 dark:border-slate-800 border-l-4 border-l-orange-500">
                        <CardHeader>
                    ...
                    {/* Way Forward */}
                    <Card className="col-span-1 lg:col-span-2 dark:bg-[#0a0a0a] border-slate-200 dark:border-slate-800">
                        <CardHeader>
