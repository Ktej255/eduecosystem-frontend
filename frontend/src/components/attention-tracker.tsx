...
export default function AttentionTracker({ onFocusUpdate }: { onFocusUpdate?: (score: number) => void }) {
        ...
        <div className="bg-gray-900 p-4 rounded-xl border border-gray-800">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-2">
                    <Activity className={`h-5 w-5 ${isTracking ? "text-green-500 animate-pulse" : "text-gray-500"}`} />
                    ...
                    <>
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="text-center">
                                ...
                                <p className="text-4xl font-bold text-white mt-2">{Math.round(focusScore)}%</p>
            ...
            <div className="space-y-2">
                ...
                <div className="w-full bg-gray-800 h-2 rounded-full overflow-hidden">
                    <div
                        className={`h-full transition-all duration-500 ${focusScore > 80 ? "bg-green-500" : focusScore > 50 ? "bg-yellow-500" : "bg-red-500"
                            }`}
