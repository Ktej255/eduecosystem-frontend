        ...
        <div className="fixed inset-0 z-50 bg-slate-950 text-slate-50 flex flex-col items-center justify-center transition-all duration-500">
            ...
            <div className={cn(
                ...
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-muted-foreground font-medium tracking-wide text-sm uppercase">Focus Mode</span>
                </div>
                ...
                <Button
                    ...
                    size="icon"
                    onClick={onExit}
                    className="hover:bg-red-500/20 hover:text-red-400 text-muted-foreground rounded-full w-12 h-12"
                >
                    <X className="w-6 h-6" />
                </Button>
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center text-center space-y-12 max-w-4xl w-full px-4">
                ...
                <div className="space-y-4 animate-in fade-in zoom-in duration-700">
                    ...
                    <p className="text-xl text-muted-foreground font-light tracking-widest uppercase">
                        {taskName}
                    </p>
                </div>
                            ...
                            <button
                                ...
                                className={cn(
                                    ...
                                    isSelected
                                        ...
                                        : "bg-slate-800/30 text-muted-foreground hover:bg-slate-800 hover:text-slate-300"
                                )}
                                title={sound.name}
                            >
