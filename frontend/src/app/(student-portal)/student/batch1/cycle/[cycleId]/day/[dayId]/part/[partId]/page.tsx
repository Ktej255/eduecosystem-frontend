...
// FORCE UPDATE: Kena Upanishad Content
const KENA_CONTENT = `# Course: The Kena Upanishad – Monasticism, Causality, & The First Question
...
export default function PartLearningPage() {
    ...
    let segment = segments[currentSegment] || DEFAULT_SEGMENTS[0];

    // FORCE OVERRIDE for Kena Upanishad
    if (cycleId === 1 && dayId === 1 && partId === 1 && currentSegment === 0) {
        segment = {
            ...segment,
