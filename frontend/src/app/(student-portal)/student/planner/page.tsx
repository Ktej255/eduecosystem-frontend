...
const monthlySchedules = {
    ...
    march: {
        ...
        days: [
            ...
            { date: 15, topic: "Resource Geography", subtitle: "World & India", gs: "Prelims", color: "bg-green-500 text-white dark:bg-green-700" },
            { date: 16, topic: "Indian Geography", subtitle: "Physical & Human", gs: "Prelims", color: "bg-green-500 text-white dark:bg-green-700" },
            { date: 17, topic: "Environment Day 1", subtitle: "Basics & CA", gs: "Prelims", color: "bg-emerald-500 text-white dark:bg-emerald-700" },
            { date: 18, topic: "Environment Day 2", subtitle: "Basics & CA", gs: "Prelims", color: "bg-emerald-500 text-white dark:bg-emerald-700" },
            { date: 19, topic: "Environment Day 3", subtitle: "Basics & CA", gs: "Prelims", color: "bg-emerald-500 text-white dark:bg-emerald-700" },
            { date: 20, topic: "Environment Day 4", subtitle: "Basics & CA", gs: "Prelims", color: "bg-emerald-500 text-white dark:bg-emerald-700" },
            { date: 21, topic: "Science & Tech Day 1", subtitle: "Basics & CA", gs: "Prelims", color: "bg-cyan-500 text-white dark:bg-cyan-700" },
            { date: 22, topic: "Science & Tech Day 2", subtitle: "Basics & CA", gs: "Prelims", color: "bg-cyan-500 text-white dark:bg-cyan-700" },
            { date: 23, topic: "Science & Tech Day 3", subtitle: "Basics & CA", gs: "Prelims", color: "bg-cyan-500 text-white dark:bg-cyan-700" },
            { date: 24, topic: "Science & Tech Day 4", subtitle: "Basics & CA", gs: "Prelims", color: "bg-cyan-500 text-white dark:bg-cyan-700" },
            { date: 25, topic: "Mega Revision", subtitle: "All Subjects", gs: "Prelims", color: "bg-indigo-500 text-white dark:bg-indigo-700" },
            { date: 26, topic: "Saturday Test", subtitle: "100 Qs, 2 Papers", gs: "Prelims", color: "bg-purple-100 dark:bg-purple-900/30" },
            { date: 27, topic: "Economy Day 1", subtitle: "Concepts & CA", gs: "Prelims", color: "bg-purple-500 text-white dark:bg-purple-700" },
            { date: 28, topic: "Economy Day 2", subtitle: "Concepts & CA", gs: "Prelims", color: "bg-purple-500 text-white dark:bg-purple-700" },
            { date: 29, topic: "Economy Day 3", subtitle: "Concepts & CA", gs: "Prelims", color: "bg-purple-500 text-white dark:bg-purple-700" },
            { date: 30, topic: "Economy Day 4", subtitle: "Concepts & CA", gs: "Prelims", color: "bg-purple-500 text-white dark:bg-purple-700" },
            { date: 31, topic: "Economy Day 5", subtitle: "Concepts & CA", gs: "Prelims", color: "bg-purple-500 text-white dark:bg-purple-700" },
        ]
    },
    april: {
        name: "April",
