        ...
        <div className="min-h-screen bg-muted dark:bg-black p-4 md:p-8">
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="space-y-2">
                    <h1 className="text-3xl font-black italic tracking-tighter text-foreground flex items-center gap-3">
                    ...
                    <Card className="bg-emerald-500/10 border-emerald-500/20">
                        <CardContent className="p-8 text-center space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">All topics are currently above 60% retrievability. Come back tomorrow!</p>
                            </div>
                        </CardContent>
                    </Card>
                ) : (
                    <div className="grid grid-cols-1 gap-4">
                        <AnimatePresence>
                            {reviewTopics.map((topic, index) => (
                                ...
                                >
                                    <Card className="group hover:border-amber-500/40 transition-all border-border dark:border-white/5 bg-card dark:bg-card/[0.02]">
                                        <CardContent className="p-6 flex items-center justify-between">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <h3 className="font-bold text-foreground capitalize tracking-tight">
                                            ...
                                            <Link href={`/student/${topic.chapterId.split('-')[0]}/${topic.chapterId}`}>
                                                <Button className="bg-slate-900 dark:bg-card dark:text-black font-black italic rounded-full h-12 px-6 group-hover:scale-105 transition-transform">
                                                    RE-MASTER NOW
                                                </Button>
                                            </Link>
                                        </CardContent>
