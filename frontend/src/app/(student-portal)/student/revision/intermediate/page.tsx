            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="w-12 h-12 rounded-full border-4 border-level-2-primary flex items-center justify-center font-bold text-level-2-primary bg-card dark:bg-neutral-800">
                            45%
                        </div>
                    </div>
                </header>
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <motion.section
                            initial={{ opacity: 0, y: 10 }}
                            animate={{ opacity: 1, y: 0 }}
                            className="bg-card dark:bg-neutral-800 p-6 rounded-2xl border border-neutral-200 dark:border-neutral-700 shadow-sm"
                        >
                            ...
                            <div className="space-y-4">
                                {schedule.map((slot, i) => (
                                    <div key={i} className={`flex items-center gap-4 p-4 rounded-xl border ${slot.day === 'Today' ? 'bg-orange-50 dark:bg-orange-900/10 border-orange-200 dark:border-orange-800' : 'bg-neutral-50 dark:bg-neutral-900 border-neutral-100 dark:border-neutral-800'}`}>
                                        <div className={`w-16 h-16 rounded-lg flex flex-col items-center justify-center shrink-0 font-bold ${slot.day === 'Today' ? 'bg-card text-orange-600 shadow-sm' : 'bg-neutral-200 text-neutral-500'}`}>
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <h3 className="font-bold text-lg text-grapho-ink">{slot.topic}</h3>
                                        </div>
                                        {slot.day === 'Today' ? (
                        ...
                        <section>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                {['Polity', 'History', 'Geography', 'Environment'].map((subj, i) => (
                                    <div key={subj} className="bg-card dark:bg-neutral-800 p-5 rounded-xl border border-neutral-200 dark:border-neutral-700 flex items-center justify-between">
                    ...
                    <div className="space-y-6">
                        <div className="bg-gradient-to-br from-indigo-900 to-purple-900 rounded-2xl p-6 text-white shadow-xl relative overflow-hidden">
                            <div className="relative z-10">
                                ...
                                <button className="w-full py-3 bg-card text-indigo-900 font-bold rounded-xl hover:bg-indigo-50 transition-colors">
                                    Take Quiz (15 Qs)
                                </button>
                            </div>
                        ...
                        <div className="bg-card dark:bg-neutral-800 rounded-2xl p-6 border border-neutral-200 dark:border-neutral-700">
