...
import { MODERN_HISTORY_CONTENT } from '@/components/upsc/subjects/history/data/modern/content-registry';
...
const HandwrittenChapter1 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter1'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter2 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter2'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter3 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter3'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter4 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter4'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter5 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter5'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter6 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter6'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter7 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter7'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter8 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter8'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter9 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter9'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter10 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter10'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter11 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter11'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter12 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter12'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter13 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter13'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter14 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter14'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter15 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter15'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter16 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter16'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter17 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter17'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter18 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter18'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter19 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter19'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter20 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter20'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter21 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter21'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter22 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter22'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter23 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter23'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter24 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter24'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter25 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter25'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter26 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter26'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter27 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter27'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter28 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter28'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter29 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter29'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter30 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter30'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter31 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter31'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter32 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter32'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter33 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter33'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter34 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter34'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter35 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter35'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter36 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter36'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter37 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter37'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter38 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter38'), { loading: () => <div>Loading Chapter...</div> });
const HandwrittenChapter39 = dynamic(() => import('@/components/upsc/subjects/history/modern/v2/HandwrittenChapter39'), { loading: () => <div>Loading Chapter...</div> });

import { ALL_MODERN_TRANSLATIONS } from '@/components/upsc/subjects/history/modern/v2/translations';
import ClassicHindiContent from '@/components/upsc/subjects/history/modern/v2/ClassicHindiContent';
...
function HistoryReadContent() {
    ...
    const handlePrevious = () => {
        ...
        if (currentId > 1) {
            router.push(`/student/upsc/history/read/${currentId - 1}?section=${section}`);
        }
    };
