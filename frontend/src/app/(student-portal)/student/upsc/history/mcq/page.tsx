...
import { getMCQsForHistoryChapters } from '@/components/upsc/subjects/history/data/history-mcqs-data';
...
import { CURRENT_AFFAIRS_DATA, CurrentAffairItem } from '@/components/upsc/subjects/current-affairs/current-affairs-data';
