...
import CourtroomScene from '@/components/upsc/platform/polity/verdict-visualizer/3d/CourtroomScene';
import VerdictOverlay from '@/components/upsc/platform/polity/verdict-visualizer/ui/VerdictOverlay';
import { LandmarkCase } from '@/components/upsc/platform/polity/verdict-visualizer/data/landmark-cases';
