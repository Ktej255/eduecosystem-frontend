...
import PolityGalaxy from '@/components/upsc/platform/polity/neural-network/PolityGalaxy';
import ControlPanel from '@/components/upsc/platform/polity/neural-network/ControlPanel';
import InfoPanel from '@/components/upsc/platform/polity/neural-network/InfoPanel';
import { PolityNode } from '@/components/upsc/platform/polity/neural-network/types';
