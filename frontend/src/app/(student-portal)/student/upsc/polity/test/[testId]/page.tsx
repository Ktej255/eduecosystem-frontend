...
import { POLITY_PAPER_1_JAN_31 } from '@/components/upsc/subjects/polity/data/tests/polity-paper1-jan31';
import { POLITY_PAPER_2_JAN_31 } from '@/components/upsc/subjects/polity/data/tests/polity-paper2-jan31';
