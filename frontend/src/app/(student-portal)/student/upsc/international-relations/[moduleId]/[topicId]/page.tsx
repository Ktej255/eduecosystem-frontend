...
import IrTopicViewer from '@/components/upsc/subjects/international-relations/IrTopicViewer';
import { IR_CONTENT_MAP } from '@/components/upsc/subjects/international-relations/data/ir-schedule-data';
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-black p-8 flex flex-col items-center justify-center">
            <div className="max-w-md w-full text-center space-y-6">
                ...
                <div className="flex justify-center gap-4">
                    <Link href={`/student/upsc/international-relations/${moduleId}`}>
