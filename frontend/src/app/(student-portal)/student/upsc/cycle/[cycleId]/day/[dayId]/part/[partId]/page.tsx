...
import PDFStudySession from "@/components/upsc/subjects/PDFStudySession";
import SimplePDFViewer from "@/components/upsc/subjects/SimplePDFViewer";
    ...
    const nextSegment = () => {
        ...
        if (currentSegment < totalSegments - 1) {
            ...
            if (partId < 3) {
                ...
                router.push(`/student/upsc/cycle/${cycleId}/day/${dayId}/part/${partId + 1}`);
            } else {
