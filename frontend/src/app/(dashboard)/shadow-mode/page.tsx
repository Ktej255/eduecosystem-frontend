        ...
        <div className="p-8 space-y-8">
            ...
            <div className="text-center space-y-4">
                ...
                <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                    Deep focus sessions to build unbreakable concentration. Complete 7 days to unlock massive rewards.
                </p>
            </div>
                ...
                <Card className="bg-gray-900 border-gray-800 p-6">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-3xl font-bold text-white">{progress?.completed_days || 0}/7</p>
                        </div>
                    </div>
                </Card>
                ...
                <Card className="bg-gray-900 border-gray-800 p-6">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-3xl font-bold text-white">{progress?.total_minutes || 0}m</p>
                        </div>
                    </div>
                </Card>
                ...
                <Card className="bg-gray-900 border-gray-800 p-6">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-3xl font-bold text-white">{progress?.avg_focus_score || 0}</p>
                        </div>
                    </div>
                </Card>
            </div>
            ...
            <Card className="bg-gray-900 border-gray-800 p-8">
                ...
                <div className="grid grid-cols-7 gap-4">
                    {[1, 2, 3, 4, 5, 6, 7].map((day) => {
                        const session = progress?.sessions?.find((s: any) => s.day_number === day)
                        ...
                        return (
                            <div
                                key={day}
                                className={`aspect-square rounded-xl border-2 flex flex-col items-center justify-center p-4 transition ${isActive
            ...
            {activeSession ? (
                <Card className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 border-purple-500/50 p-8">
                    <div className="space-y-6">
                        <div className="text-center">
                            ...
                            <p className="text-gray-400">Stay focused and complete your goals!</p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setCompletedGoals(parseInt(e.target.value) || 0)}
                                    max={activeSession.total_goals}
                                    className="bg-gray-800 border-gray-700 text-white mt-2"
                                />
                                <p className="text-xs text-gray-500 mt-1">Out of {activeSession.total_goals} goals</p>
                            </div>

                            <div>
                                <label className="text-sm text-gray-400">Focus Score (1-10)</label>
                                <Input
                                    type="range"
                                    min="1"
                                    max="10"
                                    ...
                                    className="mt-2"
                                />
                                <p className="text-center text-2xl font-bold text-white mt-2">{focusScore}/10</p>
                            </div>
                        </div>
                ...
                <Card className="bg-gray-900 border-gray-800 p-8">
                    <div className="space-y-6">
                        <div className="text-center">
                            <h3 className="text-2xl font-bold text-white mb-2">Start Your Focus Session</h3>
                            <p className="text-gray-400">Set your goals and enter shadow mode</p>
                        </div>
                ...
                <Card className="bg-gray-900 border-gray-800 p-8">
                    ...
                    <div className="space-y-3">
                        {progress.sessions.slice(0, 5).map((session: any) => (
                            ...
                            >
                                <div>
                                    <p className="text-white font-medium">Day {session.day_number}</p>
                                    <p className="text-sm text-gray-400">
                                        {session.goals_completed}/{session.total_goals} goals completed
                                    </p>
                                </div>
                                <div className="text-right">
                                    <p className="text-white font-bold">{session.duration_minutes}m</p>
                                    <p className="text-sm text-green-400">
                                        Focus: {session.focus_score ? (session.focus_score * 10).toFixed(0) : "N/A"}
                                    </p>
                                </div>
                            </div>
                        ))}
