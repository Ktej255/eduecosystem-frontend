    ...
    return (
        <main className="relative w-full h-screen overflow-hidden">
            ...
            <div className="absolute top-6 right-6 z-50 flex flex-col items-end gap-2">
                <div className="px-4 py-2 bg-white/5 backdrop-blur-md border border-white/10 rounded-lg text-right">
                    <p className="text-[10px] uppercase text-gray-500 font-bold tracking-widest">Global Ranking</p>
