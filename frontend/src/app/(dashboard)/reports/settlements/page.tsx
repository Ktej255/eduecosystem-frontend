        ...
        <CardContent>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border">
                  <th className="text-left py-3 px-4 text-sm font-semibold text-muted-foreground">Settlement</th>
                  ...
                  <th className="text-right py-3 px-4 text-sm font-semibold text-muted-foreground">Gross Amount</th>
                  <th className="text-right py-3 px-4 text-sm font-semibold text-muted-foreground">Fees & Tax</th>
                  <th className="text-right py-3 px-4 text-sm font-semibold text-muted-foreground">Net Amount</th>
              ...
              <tbody>
                {paginatedSettlements.map((stl) => (
                  <tr key={stl.id} className="border-b border-border hover:bg-muted transition-colors">
                    <td className="py-4 px-4">
                      <div>
                        <p className="font-medium text-foreground">{stl.id}</p>
                        <p className="text-xs text-muted-foreground">{stl.date}</p>
                      </div>
                    </td>
                    <td className="py-4 px-4">
                      <p className="text-sm text-muted-foreground">{stl.period}</p>
                    </td>
                    <td className="py-4 px-4 text-right">
                      <span className="text-sm font-medium text-muted-foreground">{stl.transactions}</span>
                    </td>
                    <td className="py-4 px-4 text-right">
                      <span className="text-sm text-muted-foreground">{formatCurrency(stl.grossAmount)}</span>
                    </td>
                    <td className="py-4 px-4 text-right">
                      <div>
          ...
          {paginatedSettlements.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-semibold text-muted-foreground mb-2">No settlements found</h3>
