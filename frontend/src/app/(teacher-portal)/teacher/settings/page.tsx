        ...
        <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
            ...
            <Tabs defaultValue="theme" className="w-full space-y-6">
                <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 h-auto p-1 bg-slate-100 dark:bg-slate-900 rounded-xl">
                    <TabsTrigger value="theme" className="flex items-center gap-2 py-3 md:py-2 data-[state=active]:bg-white data-[state=active]:shadow-sm dark:data-[state=active]:bg-slate-800 rounded-lg transition-all">
                        <Palette className="h-4 w-4" />
                        <span className="hidden md:inline">Theme & Brand</span>
                        <span className="md:hidden">Theme</span>
                    </TabsTrigger>
                    <TabsTrigger value="notifications" className="flex items-center gap-2 py-3 md:py-2 data-[state=active]:bg-white data-[state=active]:shadow-sm dark:data-[state=active]:bg-slate-800 rounded-lg transition-all">
                        <Bell className="h-4 w-4" />
                        <span className="hidden md:inline">Notifications</span>
                        <span className="md:hidden">Alerts</span>
                    </TabsTrigger>
                    <TabsTrigger value="roles" className="flex items-center gap-2 py-3 md:py-2 data-[state=active]:bg-white data-[state=active]:shadow-sm dark:data-[state=active]:bg-slate-800 rounded-lg transition-all">
                        <Users className="h-4 w-4" />
                        <span className="hidden md:inline">Roles & Access</span>
                        <span className="md:hidden">Roles</span>
                    </TabsTrigger>
                    <TabsTrigger value="audit" className="flex items-center gap-2 py-3 md:py-2 data-[state=active]:bg-white data-[state=active]:shadow-sm dark:data-[state=active]:bg-slate-800 rounded-lg transition-all">
