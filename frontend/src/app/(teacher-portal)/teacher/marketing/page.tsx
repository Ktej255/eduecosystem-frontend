    ...
    return (
        <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
            ...
            <Tabs defaultValue="campaigns" className="w-full space-y-6">
                <TabsList className="grid w-full grid-cols-2 md:grid-cols-5 h-auto p-1 bg-muted rounded-xl">
                    <TabsTrigger value="campaigns" className="flex items-center gap-2 py-3 md:py-2 data-[state=active]:bg-card data-[state=active]:shadow-sm dark:data-[state=active]:bg-slate-800 rounded-lg transition-all">
                        <Rocket className="h-4 w-4" />
                        <span className="hidden md:inline">Launchpad</span>
                        <span className="md:hidden">Launch</span>
                    </TabsTrigger>
                    <TabsTrigger value="discounts" className="flex items-center gap-2 py-3 md:py-2 data-[state=active]:bg-card data-[state=active]:shadow-sm dark:data-[state=active]:bg-slate-800 rounded-lg transition-all">
                        <Ticket className="h-4 w-4" />
                        <span className="hidden md:inline">Coupons</span>
                        <span className="md:hidden">Codes</span>
                    </TabsTrigger>
                    <TabsTrigger value="social" className="flex items-center gap-2 py-3 md:py-2 data-[state=active]:bg-card data-[state=active]:shadow-sm dark:data-[state=active]:bg-slate-800 rounded-lg transition-all">
                        <Smartphone className="h-4 w-4" />
                        <span className="hidden md:inline">Social Studio</span>
                        <span className="md:hidden">Social</span>
                    </TabsTrigger>
                    <TabsTrigger value="leads" className="flex items-center gap-2 py-3 md:py-2 data-[state=active]:bg-card data-[state=active]:shadow-sm dark:data-[state=active]:bg-slate-800 rounded-lg transition-all">
                        <Magnet className="h-4 w-4" />
                        <span className="hidden md:inline">Lead Magnets</span>
                        <span className="md:hidden">Leads</span>
                    </TabsTrigger>
                    <TabsTrigger value="affiliates" className="flex items-center gap-2 py-3 md:py-2 data-[state=active]:bg-card data-[state=active]:shadow-sm dark:data-[state=active]:bg-slate-800 rounded-lg transition-all">
                ...
                <TabsContent value="campaigns" className="space-y-4 focus-visible:outline-none animate-in fade-in-50 slide-in-from-bottom-2 duration-500">
                    <div className="flex items-center justify-between mb-2">
                        <h2 className="text-lg font-semibold text-foreground">Campaign Blueprint</h2>
                ...
                <TabsContent value="discounts" className="space-y-4 focus-visible:outline-none animate-in fade-in-50 slide-in-from-bottom-2 duration-500">
                    <div className="flex items-center justify-between mb-2">
                        <h2 className="text-lg font-semibold text-foreground">Discount Engine</h2>
                        <span className="text-xs text-muted-foreground bg-muted px-2 py-1 rounded-full">Live</span>
                    </div>
                    <DiscountEngine />
                </TabsContent>
                ...
                <TabsContent value="social" className="space-y-4 focus-visible:outline-none animate-in fade-in-50 slide-in-from-bottom-2 duration-500">
                    <div className="flex items-center justify-between mb-2">
                        <h2 className="text-lg font-semibold text-foreground">Social Post Previewer</h2>
                        <span className="text-xs text-muted-foreground bg-muted px-2 py-1 rounded-full">Live</span>
                    </div>
                    <SocialPostPreviewer />
                </TabsContent>
                ...
                <TabsContent value="leads" className="space-y-4 focus-visible:outline-none animate-in fade-in-50 slide-in-from-bottom-2 duration-500">
                    <div className="flex items-center justify-between mb-2">
                        <h2 className="text-lg font-semibold text-foreground">Lead Magnet Builder</h2>
                        <span className="text-xs text-muted-foreground bg-muted px-2 py-1 rounded-full">Live</span>
                    </div>
                    <LeadMagnetBuilder />
                </TabsContent>
                ...
                <TabsContent value="affiliates" className="space-y-4 focus-visible:outline-none animate-in fade-in-50 slide-in-from-bottom-2 duration-500">
                    <div className="flex items-center justify-between mb-2">
                        <h2 className="text-lg font-semibold text-foreground">Affiliate Dashboard</h2>
                        <span className="text-xs text-muted-foreground bg-muted px-2 py-1 rounded-full">Live</span>
                    </div>
                    <AffiliateDashboard />
                </TabsContent>
