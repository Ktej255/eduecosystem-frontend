...
def clean_text(text):
    ...
    artifacts = ["Copyright", "©", "Back to Top", "Disclaimer", "All rights reserved", "Sarit Classes", "UPSC Physics Optional", "UPSC Maths Optional"]
    for a in artifacts:
...
def generate_optional_page(slug, data):
    ...
    strategy_list = data.get('strategy_list', [
        "Master the fundamentals before moving to complex problem solving.",
        "Maintain a formula/concept sheet for quick revision.",
        "Link theoretical proofs with numerical applications.",
        "Regularly practice diagrams and circuit/flowcharts.",
        "Analyze trends in PYQs to prioritize high-yield modules.",
        "Ensure clear handwriting and structured presentation in answers."
    ])
    strategy_html = "".join([f'<li>{s}</li>' for f, s in enumerate(strategy_list[:6])])
    
    books = data.get('books', ["Standard Professional Textbooks", "Sarit Classes Specialized Notes", "UPSC Official Curriculum Guide"])
    ...
    <div class="optional-layout">
        <div class="optional-main">
            <div class="paper-section">
                <h2 class="paper-title">Paper I: Core Theoretical Foundations</h2>
            ...
            <div class="paper-section">
                <h2 class="paper-title">Paper II: Applied Concepts & Case Studies</h2>
                <div class="accordion-container">
                    {p2_html}
                </div>
            </div>
...
def main():
    batch_data = {
        "optional-management": {
            "title": "Management",
            "paper1": [
                {"title": "Management Foundations & OB", "topics": ["Evolution of management thoughts", "Decision making processes", "Managerial skills", "Work stress and stress management", "Organizational dynamics (power, politics, conflict)"]},
                {"title": "HRM & Accounting", "topics": ["Job evaluate", "Human resource planning", "HRIS", "GAAP", "Balance sheet analysis", "Cost accounting ledger"]}
            ],
            "paper2": [
                {"title": "Quantitative Techniques & Operations", "topics": ["Chi-square test, ANOVA", "Linear programming (Simplex)", "Supply chain management", "Six Sigma", "Project management (R&D)"]},
                {"title": "Strategic Management & Gov", "topics": ["PESTEL & SWOT", "Porter's Five Forces", "Corporate governance", "FDI & M&A", "Regional cooperation (FTAs)"]}
            ]
        },
        "optional-mathematics": {
            "title": "Mathematics",
            "paper1": [
                {"title": "Linear Algebra & Calculus", "topics": ["Vector spaces", "Linear transformations", "Cayley-Hamilton theorem", "Lagrange’s method of multipliers", "Riemann’s definite integrals"]},
                {"title": "Geometry & Diff Equations", "topics": ["Shortest distance skew lines", "Clairaut’s equation", "Laplace transforms", "Green’s, Gauss and Stokes’ theorems", "Stability of equilibrium"]}
            ],
            "paper2": [
                {"title": "Modern Algebra & Real Analysis", "topics": ["Lagrange’s Theorem", "Integral domains", "Euclidean domains", "Cauchy sequence", "Riemann integral"]},
                {"title": "Applied Maths & Programming", "topics": ["Analytic function (C-R equations)", "Simplex Method Duality", "Heat & Laplace equation", "Newton-Raphson methods", "Euler & Runge Kutta-methods"]}
            ]
        },
        "optional-mechanical-engineering": {
            "title": "Mechanical Engineering",
            "paper1": [
                {"title": "Mechanics & Materials", "topics": ["Equations of equilibrium", "Kinematics of particles", "Generalized Hooke’s law", "Bending shear", "Theories of failure", "Non-metals (plastics, ceramics)"]},
                {"title": "Machine Design & Tooling", "topics": ["Cams & Gears", "Linear vibration analysis", "NC and CNC machining", "Jigs and fixtures", "Metrology (fits and tolerances)"]}
            ],
            "paper2": [
                {"title": "Thermodynamics & IC Engines", "topics": ["Laws of thermodynamics", "Rankine cycle", "Internal Combustion Engines", "Heat Transfer"]},
                {"title": "Manufacturing & Robotics", "topics": ["Inventory management", "JIT systems", "TQM & Lean Organizations", "Basic Robotics"]}
            ]
        },
        "optional-medical-science": {
            "title": "Medical Science",
            "paper1": [
                {"title": "Anatomy & Physiology", "topics": ["Applied anatomy (blood/nerve supply)", "Embryology (congenital abnormalities)", "Autonomic Nervous System", "Basal ganglia functions", "Mechanism of action of hormones"]},
                {"title": "Biochemistry & Pathology", "topics": ["RFLP & PCR", "Inflammation and repair", "Benign and malignant tumours", "Pathogenesis of cirrhosis", "Humoral and cell-mediated immunity"]}
            ],
            "paper2": [
                {"title": "General Medicine", "topics": ["Common communicable diseases", "Tropical diseases", "Nutrition", "Geriatrics"]},
                {"title": "Social & Preventive Medicine", "topics": ["Health policy", "Epidemiology", "Family Planning", "Mental health"]}
            ]
        },
        "optional-physics": {
            "title": "Physics",
            "paper1": [
                {"title": "Mechanics & Relativity", "topics": ["Coriolis accelerations", "Kepler’s laws", "Rutherford scattering", "Lorentz transformations", "Mass-energy relation"]},
                {"title": "Waves & Electromagnetism", "topics": ["Phase and group velocities", "Fraunhofer diffraction", "Lasers (Einstein A and B coefficients)", "Maxwell’s equations", "Black body radiation"]}
            ],
            "paper2": [
                {"title": "Quantum & Atomic Physics", "topics": ["Wave-particle duality", "Schroedinger equation", "Zeeman effect", "Raman effect", "NMR and EPR"]},
                {"title": "Nuclear & Solid State", "topics": ["Semi-empirical mass formula", "Quark structure of hadrons", "Band theory of solids", "Meissner effect", "PNP & NPN transistors"]}
            ]
        }
    }
