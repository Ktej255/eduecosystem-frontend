...
def reschedule_tasks(
    ...
    tasks = crud_task.get_multi_by_owner(db=db, user_id=current_user.id, skip=0, limit=100)
    ...
    current_time = datetime(tomorrow.year, tomorrow.month, tomorrow.day, peak_hour, 0, 0)
