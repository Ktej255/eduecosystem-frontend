...
Revision ID: 9216918ff6cf
Revises: 9c9157d5ac63
Create Date: 2026-01-02 23:37:36.411269
...
def downgrade() -> None:
    ...
    sa.Column('call_type', sa.VARCHAR(length=20), nullable=False),
    sa.Column('phone_number', sa.VARCHAR(length=20), nullable=True),
    sa.Column('duration_seconds', sa.INTEGER(), nullable=True),
    sa.Column('outcome', sa.VARCHAR(length=50), nullable=True),
    sa.Column('notes', sa.TEXT(), nullable=True),
    sa.Column('call_started_at', sa.DATETIME(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    ...
    sa.Column('is_ras_authorized', sa.BOOLEAN(), server_default=sa.text("'0'"), nullable=True),
    ...
    sa.Column('summary_text', sa.VARCHAR(), nullable=True),
