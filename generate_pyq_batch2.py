...
<body>
    ...
    <div class="pyq-container">
        <div class="accordion-item" style="border: 2px solid var(--gold); margin-bottom: 32px; border-radius: 16px;">
            <div class="accordion-header" style="background: rgba(212,175,55,0.1);">
                <h4 style="color: var(--gold);">Special: 2024 Trend Analysis</h4>
                <i class="fas fa-bolt" style="color: var(--gold);"></i>
            </div>
            <div class="accordion-body" style="display: block; padding: 24px;">
                <p style="font-size: 0.95rem; line-height: 1.6;">2024 saw a 15% increase in conceptual multi-statement questions. Candidates should focus on inter-disciplinary links between {subject_title} and Current Affairs.</p>
            </div>
        </div>
...
def main():
    batch_data = {
        "pyq-science-tech": {
            "title": "Science & Tech",
            "years": [
                {"year": 2024, "questions": ["Denoting 'interoperable network of 3D virtual worlds' (Metaverse).", "Radioisotope thermoelectric generators (RTGs) in spacecraft.", "Giant stars vs Dwarf stars nuclear reaction rates.", "Hydrogels usage in controlled drug delivery."]},
                {"year": 2023, "questions": ["Carbon fibres in automobiles and reuse potential.", "Accelerometer functions in smartphones and car crashes.", "Green hydrogen blending and fuel cell usage."]}
            ]
        },
        "pyq-economy": {
            "title": "Indian Economy",
            "years": [
                {"year": 2024, "questions": ["US Treasury Bonds and faith of US Government debt.", "Digital Rupee (CBDC) as a liability on RBI balance sheet.", "Genetically Modified food import laws in India.", "CSR rules regarding direct company benefit expenditures."]},
                {"year": 2023, "questions": ["Central Banks interest rate hikes and consumer price counteract.", "Carbon markets as a tool against climate change.", "InvITs and tax exemption on interest income."]}
            ]
        },
        "pyq-ancient-history": {
            "title": "Ancient History & Art",
            "years": [
                {"year": 2024, "questions": ["Harappan sites and their architectural significance.", "Influence of Gandhara art on later Buddhist sculptures.", "Major ancient trade routes and commodities exchanged."]},
                {"year": 2023, "questions": ["Temple architecture styles: Nagara vs Dravida.", "Philosophical schools of Ancient India (Sankhya, Vedanta)."]}
            ]
        },
        "pyq-medieval-history": {
            "title": "Medieval History",
            "years": [
                {"year": 2024, "questions": ["Administrative reforms under Alauddin Khalji.", "Evolution of the Mansabdari system under Akbar.", "Cultural syncretism during the Bhakti and Sufi movements."]},
                {"year": 2023, "questions": ["Inter-state relations during the Vijayanagara Empire.", "Development of military technology in Medieval India."]}
            ]
        }
    }
